...
class AssessmentController extends Controller
{
    ...
    {
        // Get only the latest PTSD assessment for this user
    ...
    public function submitDcmChecklist(Request $request, Assessment $assessment)
    {
        ...
        $request->validate([
            ...
            'problems.*' => 'sometimes|integer|min:0|max:1'
        ]);
        ...
        try {
            ...
            // Save individual answers for all 100 problems
            for ($problemId = 1; $problemId <= 100; $problemId++) {
                $answerValue = $request->problems[$problemId] ?? 0; // Default to 0 if not checked
