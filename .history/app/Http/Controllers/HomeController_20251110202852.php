...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        // Total UMKM Digital (hanya yang description-nya mengandung "UMKM Digital")
        // Jangan hitung Smart Services yang juga mengandung kata "Digital"
        $totalUmkm = Coordinate::where('description', 'like', '%UMKM Digital%')->count();
