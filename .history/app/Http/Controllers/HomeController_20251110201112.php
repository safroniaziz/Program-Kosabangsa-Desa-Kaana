...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        // Total Smart Services (bisa dari jumlah layanan aktif, untuk sekarang kita hitung dari coordinates yang bukan UMKM dan bukan faskes)
        $totalSmartServices = 15; // Default, bisa dihitung dari tabel services jika ada
