        ...
        if ($request->ajax() || $request->wantsJson()) {
            ...
            return response()->json([
                'data' => $results->map(function ($assessment) {
                    ...
                    // Action button - only history
                    $typeForRoute = $assessment->assessment_type === 'checklist_masalah' ? 'dcm' : $assessment->assessment_type;
                    $action = '<button type="button" class="btn btn-sm btn-primary btn-history" data-user-id="' . $assessment->user_id . '" data-type="' . $typeForRoute . '" title="Lihat Riwayat">
