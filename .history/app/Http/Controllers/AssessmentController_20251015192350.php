...
class AssessmentController extends Controller
{
    ...
    private function getQuestionsForAssessment(Assessment $assessment): array
    {
        switch ($assessment->type) {
            case 'pcl5':
                return [
                    'questions' => PCL5Questions::getAllQuestions(),
                    'scale' => PCL5Questions::getScaleOptions(),
                    'instructions' => PCL5Questions::INSTRUCTIONS,
                    'disclaimer' => PCL5Questions::DISCLAIMER
                ];

            case 'dass21':
                return [
                    'questions' => DASS21Questions::getAllQuestions(),
                    'scale' => DASS21Questions::getScaleOptions(),
                    'instructions' => DASS21Questions::INSTRUCTIONS,
                    'disclaimer' => DASS21Questions::DISCLAIMER
                ];
    ...
    /**
     * Legacy assessment page (for disaster preparedness)
     */
