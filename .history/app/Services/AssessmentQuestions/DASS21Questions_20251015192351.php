...
class DASS21Questions
{
    ...
    const INSTRUCTIONS = "Mohon baca setiap pernyataan dan pilih angka 0, 1, 2 atau 3 yang menunjukkan seberapa banyak pernyataan itu berlaku untuk Anda selama seminggu yang lalu. Tidak ada jawaban yang benar atau salah. Jangan terlalu lama memikirkan setiap pernyataan.";

    const DISCLAIMER = "Hasil ini hanya untuk screening dan bukan diagnosis. Konsultasikan dengan tenaga kesehatan mental jika diperlukan.";
