                ...
                <div class="space-y-8">
                    ...
                    <div data-aos="fade-up" data-aos-delay="200">
                        <h1 class="text-5xl lg:text-6xl font-black text-white mb-6 leading-tight">
                            ...
                            <span class="block">dari Konsep hingga Implementasi</span>
                        </h1>
                    </div>

                    <div data-aos="fade-up" data-aos-delay="300">
                        <p class="text-xl text-gray-200 mb-8 leading-relaxed">
                            Pelajari seluruh aspek <span class="text-blue-400 font-semibold">pengelolaan incubator bisnis</span>,
                            mulai dari <span class="text-indigo-400 font-semibold">strategi pengembangan startup</span> hingga 
                            <span class="text-cyan-400 font-semibold">manajemen ekosistem entrepreneurship</span> yang berkelanjutan.
                        </p>
                    </div>
