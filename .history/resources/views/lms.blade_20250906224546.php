            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white rounded-2xl border border-slate-200 overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 group module-card"
                    ...
                    <div class="p-4 bg-white">
                        ...
                        <div class="space-y-3">
                            @if($module['status'] === 'available')
                            <button onclick="openLearningPage({{ $module['number'] }}, @json($module))" class="w-full flex items-center justify-center gap-2 p-3.5 bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 rounded-2xl text-white border border-green-400/50 transition-all duration-300 transform hover:scale-[1.02] shadow-lg hover:shadow-xl">
