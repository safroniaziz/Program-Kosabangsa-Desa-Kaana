...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const desaPointsOfInterest = [
        {
            name: 'Danau Onta',
            description: 'Danau alami di wilayah Desa Kaana, Pulau Enggano.',
            coordinates: [102.26697600871147, -5.476712441788056],
            category: 'nature'
        },
        {
            name: 'Danau Pulau',
            description: 'Danau yang terletak di pesisir Desa Kaana, Pulau Enggano.',
            coordinates: [102.33866884546806, -5.403715473561784],
            category: 'nature'
        },
        {
            name: "Masjid Pal Empat Ka'ana",
            description: 'Tempat ibadah umat Islam di wilayah Pal Empat, Desa Kaana.',
            coordinates: [102.35621881872818, -5.4038399900619],
            category: 'worship'
        },
        {
            name: 'Pesantren As Salam Al Azhar',
            description: 'Lembaga pendidikan berbasis Islam di Desa Kaana, Pulau Enggano.',
            coordinates: [102.34737400107242, -5.385645633181521],
            category: 'education'
        },
        {
            name: 'Al Muhsineen Jami Mosque Kaana',
            description: 'Masjid jami di Desa Kaana, Pulau Enggano.',
            coordinates: [102.34750067015548, -5.375209707505798],
            category: 'worship'
        },
        {
            name: 'Pantai Kikuba',
            description: 'Pantai di wilayah Desa Kaana, Pulau Enggano.',
            coordinates: [102.35125850293794, -5.3721312219924755],
            category: 'nature'
        },
        {
            name: "Pantai Ka'ana Enggano",
            description: 'Pantai di Desa Kaana, Pulau Enggano, Kabupaten Bengkulu Utara.',
            coordinates: [102.34494120137057, -5.371939736733691],
            category: 'nature'
        },
        {
            name: 'Kaana Beach Camp & Resort',
            description: 'Fasilitas akomodasi dan rekreasi di pantai Desa Kaana.',
            coordinates: [102.34261861727693, -5.371497895633549],
            category: 'tourism'
        },
        {
            name: 'Pondok Kebun',
            description: 'Area kebun dan pondok di Desa Kaana, Pulau Enggano.',
            coordinates: [102.33559135559713, -5.374811972028578],
            category: 'tourism'
        },
        {
            name: "Pantai Be'wa Trans Malakoni",
            description: 'Pantai di wilayah Trans Malakoni, Desa Kaana, Pulau Enggano.',
            coordinates: [102.3306204926123, -5.364648747359315],
            category: 'nature'
        },
        {
            name: "Masjid Trans Ka'ana",
            description: 'Tempat ibadah umat Islam di wilayah Trans Kaana, Desa Kaana.',
