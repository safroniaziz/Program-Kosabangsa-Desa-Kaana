...
<body>
            ...
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden md:flex items-center">
                    <div class="flex items-center space-x-1">
                        ...
                        <!-- Assessment Dropdown -->
                        <div class="relative" id="assessmentDropdown">
                            <button class="nav-item {{ request()->routeIs('assessment*') ? 'active' : '' }} flex items-center" id="assessmentButton">
                                Assessment
                                <svg class="w-4 h-4 ml-1 transition-transform" id="assessmentIcon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                                </svg>
                            </button>

                            <div class="hidden absolute left-0 mt-2 w-64 bg-white rounded-xl shadow-xl border border-gray-100 overflow-hidden z-50" id="assessmentMenu">
                                <div class="py-2">
                                    <a href="{{ route('assessment') }}" class="block px-4 py-3 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition-colors">
                                        <div class="flex items-center">
                                            ...
                                            <div>
                                                <div class="font-medium">Kesiapan Bencana</div>
                                                <div class="text-xs text-gray-500">Evaluasi kesiapan menghadapi bencana</div>
                                            </div>
                                        </div>
                                    </a>

                                    @auth
                                    <a href="{{ route('assessment.mental-health') }}" class="block px-4 py-3 text-sm text-gray-700 hover:bg-purple-50 hover:text-purple-600 transition-colors">
                                        <div class="flex items-center">
                                            <svg class="w-5 h-5 mr-3 text-purple-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"></path>
                                            </svg>
                                            <div>
                                                <div class="font-medium">Kesehatan Mental</div>
                                                <div class="text-xs text-gray-500">PTSD Diagnostic & Checklist Masalah</div>
                                            </div>
                                        </div>
                                    </a>

                                    <a href="{{ route('assessment.history') }}" class="block px-4 py-3 text-sm text-gray-700 hover:bg-green-50 hover:text-green-600 transition-colors">
                                        <div class="flex items-center">
                                            <svg class="w-5 h-5 mr-3 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                            </svg>
                                            <div>
                                                <div class="font-medium">Riwayat Assessment</div>
                                                <div class="text-xs text-gray-500">Lihat hasil assessment sebelumnya</div>
                                            </div>
                                        </div>
                                    </a>
                                    @endauth
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            // Assessment Dropdown functionality
            let assessmentDropdownTimeout;
            
            $('#assessmentDropdown').hover(
                function() {
                    // Mouse enter
                    clearTimeout(assessmentDropdownTimeout);
                    $('#assessmentMenu').removeClass('hidden');
                    $('#assessmentIcon').addClass('rotate-180');
                },
                function() {
                    // Mouse leave
                    assessmentDropdownTimeout = setTimeout(function() {
                        $('#assessmentMenu').addClass('hidden');
                        $('#assessmentIcon').removeClass('rotate-180');
                    }, 200); // 200ms delay before hiding
                }
            );

            // Keep dropdown open when hovering over the menu itself
            $('#assessmentMenu').hover(
                function() {
                    clearTimeout(assessmentDropdownTimeout);
                },
                function() {
