                ...
                <div class="hidden md:flex items-center">
                    <div class="flex items-center space-x-1">
                        ...
                        <div class="relative group">
                            <button class="nav-item {{ request()->routeIs('assessment*') ? 'active' : '' }} flex items-center">
                                Assessment
                            ...
                            <div class="hidden group-hover:block absolute left-0 mt-2 w-64 bg-white rounded-xl shadow-xl border border-gray-100 overflow-hidden z-50">
                                <div class="py-2">
