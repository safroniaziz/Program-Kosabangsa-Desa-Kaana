            ...
            <div class="relative">
                ...
                <div class="relative flex items-center mb-20 last:mb-0" data-aos="fade-up" data-aos-delay="{{ $index * 100 }}">
                    ...
                    <div class="absolute left-1/2 transform -translate-x-1/2 z-20">
                        <div class="relative">
                            <!-- Outer glow ring -->
                            <div class="w-20 h-20 bg-gradient-to-br {{ $path['color'] }} rounded-full absolute inset-0 blur-lg opacity-30 animate-pulse"></div>
                            <!-- Main circle -->
                            <div class="w-16 h-16 bg-gradient-to-br {{ $path['color'] }} rounded-full border-4 border-white shadow-2xl flex items-center justify-center relative transform hover:scale-110 transition-all duration-500">
                    ...
                    <div class="w-full {{ $path['position'] === 'left' ? 'pr-8 md:pr-16' : 'pl-8 md:pl-16' }} {{ $path['position'] === 'right' ? 'md:ml-auto' : '' }}">
                        <div class="bg-gradient-to-br {{ $path['bgColor'] }} backdrop-blur-sm border border-white/50 rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 {{ $path['position'] === 'left' ? 'md:text-right' : '' }} max-w-xl {{ $path['position'] === 'right' ? 'md:ml-auto' : '' }} group hover:border-white/80 relative overflow-hidden">
                            
                            <!-- Background decoration -->
                            <div class="absolute top-0 {{ $path['position'] === 'left' ? 'left-0' : 'right-0' }} w-32 h-32 bg-gradient-to-br {{ $path['color'] }} opacity-10 rounded-full blur-3xl transform {{ $path['position'] === 'left' ? '-translate-x-8' : 'translate-x-8' }} -translate-y-8"></div>
                            ...
                            <div class="relative z-10">
                                ...
                                <div class="inline-flex items-center gap-3 bg-white/90 backdrop-blur-sm text-slate-700 px-6 py-3 rounded-full text-sm font-bold mb-6 shadow-lg border border-white/50 group-hover:scale-105 transition-all duration-300">
                                    <svg class="w-5 h-5 text-gradient-to-r {{ $path['color'] }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div class="space-y-3">
                                    ...
                                    <div class="flex items-center gap-3 text-sm {{ $path['position'] === 'left' ? 'md:justify-end' : '' }} group-hover:translate-x-2 transition-transform duration-300" style="animation-delay: {{ $moduleIndex * 100 }}ms;">
                                ...
                                <div class="mt-8 {{ $path['position'] === 'left' ? 'md:text-right' : '' }}">
                                    <button class="inline-flex items-center gap-2 bg-gradient-to-r {{ $path['color'] }} text-white px-6 py-3 rounded-full font-bold text-sm shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300">
                                        @if($path['progress'] > 0)
