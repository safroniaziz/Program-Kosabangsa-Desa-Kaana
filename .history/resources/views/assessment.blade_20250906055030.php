                    ...
                    <div>
                        ...
                        <div class="mt-4 p-3 bg-gray-50 rounded-lg">
                            <div class="flex justify-between text-xs text-gray-600">
                                <span>Dijawab: <span id="answered-count" class="font-semibold text-green-600">0</span></span>
                                <span>Sisa: <span id="remaining-count" class="font-semibold text-blue-600">0</span></span>
                            </div>
                        </div>
                    </div>
                </div>
...
$(document).ready(function() {
    ...
    $(document).on('mouseenter', '.question-nav-item', function() {
        ...
        if (sectionIndex !== undefined && questionIndex !== undefined) {
            ...
            // Create tooltip
            const tooltip = $(`
                <div class="absolute z-50 bg-gray-900 text-white text-xs rounded-lg py-2 px-3 -top-12 left-1/2 transform -translate-x-1/2 whitespace-nowrap">
