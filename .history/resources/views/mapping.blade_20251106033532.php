...
.custom-popup.mapboxgl-popup-anchor-top,
.custom-popup.mapboxgl-popup-anchor-bottom,
.custom-popup.mapboxgl-popup-anchor-left,
.custom-popup.mapboxgl-popup-anchor-right,
.custom-popup.mapboxgl-popup-anchor-center {
    opacity: 1;
    visibility: visible;
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const desaPointsOfInterest = [
            ...
            {
                "name": "Danau Pulau",
                "description": "Danau seluas ± 1,76 ha yang dikelilingi hutan lindung sebagai tangkapan air bagi sawah Desa Ka’ana. :contentReference[oaicite:2]{index=2}",
