        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
            ...
            <div class="chart-container" data-aos="fade-right" data-aos-delay="800">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <span class="text-sm text-gray-500 bg-gray-100 px-3 py-1 rounded-full">Area Chart</span>
                </div>

                <!-- Area Chart Representation -->
                <div class="h-48 p-4 bg-gradient-to-t from-blue-50 to-white rounded-xl border border-blue-100 mb-6 relative overflow-hidden">
                    <!-- Area Chart Lines -->
                    <div class="absolute bottom-4 left-4 right-4 h-32">
                        <div class="relative h-full">
                            <!-- TK Line -->
                            <div class="absolute bottom-0 left-0 w-full h-20 bg-gradient-to-t from-green-200 to-green-100 rounded-t opacity-80"></div>
                            <!-- SD Line -->
                            <div class="absolute bottom-0 left-0 w-full h-24 bg-gradient-to-t from-blue-200 to-blue-100 rounded-t opacity-70"></div>
                            <!-- SMP Line -->
                            <div class="absolute bottom-0 left-0 w-full h-16 bg-gradient-to-t from-yellow-200 to-yellow-100 rounded-t opacity-60"></div>
                            <!-- SMA Line -->
                            <div class="absolute bottom-0 left-0 w-full h-12 bg-gradient-to-t from-red-200 to-red-100 rounded-t opacity-50"></div>
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-2 gap-3">
                    <div class="text-center p-3 bg-green-50 rounded-lg">
                        ...
                        <div class="text-xs text-gray-600">Anak Usia Sekolah</div>
                    </div>
                    <div class="text-center p-3 bg-blue-50 rounded-lg">
                        <div class="text-lg font-bold text-blue-600">94%</div>
                        <div class="text-xs text-gray-600">Angka Partisipasi</div>
                    </div>
                </div>
            </div>
