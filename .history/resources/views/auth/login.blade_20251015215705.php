    ...
    <form method="POST" action="{{ route('login') }}" class="space-y-4">
        ...
        <div class="flex items-center justify-between pt-1">
            <label for="remember_me" class="flex items-center group cursor-pointer">
                <input id="remember_me" type="checkbox" class="w-4 h-4 rounded border-2 border-gray-300 text-blue-600 shadow-sm focus:ring-blue-500 focus:ring-2 transition-all" name="remember">
                <span class="ml-2 text-sm text-gray-600 group-hover:text-gray-800 font-medium transition-colors">{{ __('Ingat saya') }}</span>
            </label>
        ...
        <div class="text-center">
            <a href="{{ route('register') }}" class="inline-flex items-center justify-center w-full px-4 py-2.5 border-2 border-blue-200 bg-blue-50 hover:bg-blue-100 text-blue-700 font-semibold rounded-xl transition-all duration-300 hover:border-blue-300 hover:-translate-y-0.5 hover:shadow-md group">
