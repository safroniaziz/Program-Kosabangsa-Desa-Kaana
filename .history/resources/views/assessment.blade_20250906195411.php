    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 max-w-7xl">
        ...
        <div class="grid lg:grid-cols-4 gap-8">
            ...
            <div class="lg:col-span-1">
                <div class="navigation-sidebar rounded-2xl p-4 lg:p-6 shadow-xl overflow-hidden">
                    <!-- Progress Overview -->
                    <div class="mb-6">
                        ...
                        <div class="mt-4 p-3 bg-gradient-to-r from-gray-50 to-blue-50 rounded-xl border border-gray-200">
                            <div class="grid grid-cols-2 gap-3 text-xs">
                                <div class="text-center">
                                    <div class="text-base lg:text-lg font-bold text-green-600" id="answered-count">0</div>
                                    <div class="text-gray-600">Dijawab</div>
                                </div>
                                <div class="text-center">
                                    <div class="text-base lg:text-lg font-bold text-orange-600" id="remaining-count">7</div>
                ...
                <div class="space-y-4" id="options-container">
                    ${question.options.map((option, index) => `
                        <label class="radio-option flex items-start p-6 rounded-2xl cursor-pointer group">
                            ...
                            <div class="radio-circle mr-4 mt-1"></div>
                            <div class="flex-1">
