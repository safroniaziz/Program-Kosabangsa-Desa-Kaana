...
$(document).ready(function() {
    ...
    // Back to Top Functionality - Fixed version
    function scrollToTop() {
        // Use native scrollTo instead of jQuery animate to avoid easing issues
        window.scrollTo({
            top: 0,
            behavior: 'smooth'
        });
    ...
    // Alternative jQuery version without easing
    ...
    // Jump to specific question - Fixed version
    function jumpToQuestion(sectionIndex, questionIndex) {
        currentSection = sectionIndex;
        currentQuestion = questionIndex;
        renderCurrentQuestion();
