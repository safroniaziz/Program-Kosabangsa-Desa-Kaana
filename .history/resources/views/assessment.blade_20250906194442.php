...
$(document).ready(function() {
    ...
    function renderCurrentQuestion() {
        ...
        if (savedAnswer) {
            ...
            $(`input[name="q${question.id}"][value="${savedAnswer}"]`).siblings('div').find('.hidden').removeClass('hidden');
        }
    ...
    $(document).on('change', 'input[type="radio"]', function() {
        ...
        $('.radio-option input:checked').siblings('div').find('.hidden').removeClass('hidden');
