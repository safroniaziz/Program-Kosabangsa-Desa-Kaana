...
<div id="floatingChatBtn" class="fixed bottom-6 right-6 z-30">
    <button onclick="openChatConseling()" class="w-16 h-16 bg-gradient-to-r from-orange-500 to-red-500 text-white rounded-full shadow-2xl hover:shadow-3xl transform hover:scale-110 transition-all duration-300 flex items-center justify-center group">
    ...
    <!-- Tooltip -->
    <div class="absolute bottom-20 right-0 bg-gray-900 text-white text-sm rounded-lg py-2 px-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap">
