...
<section id="modules" class="py-32 bg-gradient-to-b from-gray-50 via-white to-gray-50">
    <div class="container mx-auto px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="course-card rounded-3xl overflow-hidden shadow-elegant hover:shadow-elegant-lg border border-white/20 animate-elegant-fade" style="animation-delay: {{ $index * 0.1 }}s;">
                <div class="relative h-72 overflow-hidden">
                    ...
                    <div class="absolute top-6 left-6">
                        <span class="inline-flex items-center px-4 py-2 glass-card rounded-xl text-sm font-bold text-white border border-white/20 shadow-elegant">
                    ...
                    <div class="absolute top-6 right-6">
                        <div class="flex items-center gap-2 px-4 py-2 glass-card rounded-xl text-sm font-bold text-white border border-white/20 shadow-elegant">
                    ...
                    <div class="absolute bottom-6 left-6 right-6">
                        <div class="flex items-center justify-between text-white text-sm font-semibold mb-2">
                            <span>Progress</span>
                            <span>{{ $module['progress'] }}%</span>
                        </div>
                        <div class="w-full bg-white/20 rounded-full h-2 backdrop-blur-sm">
                            <div class="gradient-elegant h-2 rounded-full transition-all duration-1000" style="width: {{ $module['progress'] }}%"></div>
                        </div>
                    </div>
                    @endif
                </div>
                ...
                <div class="p-10">
                    <div class="flex items-center justify-between mb-6">
                        <span class="px-5 py-3 glass-card text-gray-700 rounded-2xl text-sm font-bold border border-white/20 shadow-elegant">
                            {{ $module['category'] }}
                        </span>
                    ...
                    <h3 class="text-3xl font-black elegant-title mb-6 leading-tight">
                        {{ $module['title'] }}
                    </h3>

                    <p class="elegant-subtitle text-lg mb-8 leading-relaxed">
                        {{ $module['description'] }}
                    </p>

                    <!-- Elegant Lessons Preview -->
                    <div class="mb-8">
                        <h4 class="font-bold elegant-title text-lg mb-4">Materi Pembelajaran:</h4>
                        <div class="space-y-3">
                            @foreach(array_slice($module['lessons_list'], 0, 3) as $lesson)
                            <div class="flex items-center gap-4 p-4 glass-card rounded-2xl border border-white/20 shadow-elegant hover:shadow-elegant-lg transition-all duration-300">
                                @if($lesson['type'] === 'video')
                                <div class="w-10 h-10 gradient-elegant rounded-2xl flex items-center justify-center shadow-elegant">
                                    <svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                                        <path d="M8 5v14l11-7z"/>
                                    </svg>
                                </div>
                                @else
                                <div class="w-10 h-10 bg-blue-500 rounded-2xl flex items-center justify-center shadow-elegant">
                                    <svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                                ...
                                @endif
                                <div class="flex-1">
                                    <div class="text-sm font-bold elegant-title">{{ $lesson['title'] }}</div>
                                    <div class="text-xs elegant-subtitle">{{ $lesson['duration'] }}</div>
                                </div>
                            </div>
                            @endforeach
                            @if(count($module['lessons_list']) > 3)
                            <div class="text-center py-3">
                                <span class="inline-flex items-center px-4 py-2 glass-card rounded-xl text-sm font-semibold text-gray-600 border border-white/20">
                    ...
                    <!-- Elegant Module Info -->
                    <div class="flex items-center gap-6 mb-8 py-6 border-t border-b border-gray-200/50">
                        <div class="w-16 h-16 gradient-elegant rounded-3xl flex items-center justify-center text-white font-black text-xl shadow-elegant">
                            {{ $index + 1 }}
                        </div>
                        <div>
                            <div class="font-black elegant-title text-xl">Modul {{ $index + 1 }}</div>
                            <div class="elegant-subtitle">{{ $module['lessons'] }}</div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <button onclick="openModule({{ $index + 1 }})" class="group gradient-elegant text-white px-8 py-4 rounded-2xl font-bold hover:scale-105 transition-all duration-500 transform hover:-translate-y-1 shadow-elegant hover:shadow-elegant-lg flex items-center gap-3 border border-white/20">
        ...
        <div class="text-center mt-20">
            <button class="group gradient-elegant text-white px-16 py-6 rounded-3xl font-bold text-xl hover:scale-105 transition-all duration-500 transform hover:-translate-y-2 shadow-elegant hover:shadow-elegant-lg border border-white/20">
                <span class="group-hover:scale-110 transition-transform duration-300 inline-block mr-3">📚</span>
                Lihat Semua Modul
                <svg class="w-6 h-6 inline ml-3 group-hover:translate-x-1 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6"/>
                </svg>
            </button>
        </div>
