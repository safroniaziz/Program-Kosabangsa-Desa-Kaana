...
<section class="py-20 bg-gradient-to-br from-blue-600 to-purple-700">
    <div class="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
        ...
        <p class="text-xl text-blue-100 mb-8 animate-slide-up">
            Kenali potensi diri Anda melalui asesmen komprehensif untuk pengembangan karir dan personal yang lebih baik.
        </p>
    </div>
</section>
...
<section class="py-20 bg-gray-50">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white rounded-2xl shadow-xl p-8 md:p-12 animate-on-scroll">
            <div class="text-center mb-12">
                ...
                <h2 class="text-3xl font-bold text-gray-900 mb-4">Mulai Assessment Anda</h2>
                <p class="text-gray-600">Jawab pertanyaan-pertanyaan berikut dengan jujur untuk mendapatkan hasil yang akurat.</p>
            </div>
                ...
                <div class="bg-gray-50 rounded-xl p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" id="fullName" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors" placeholder="Masukkan nama lengkap">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Usia</label>
                            <select id="age" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors">
                        ...
                        <div>
                            ...
                            <select id="education" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors">
