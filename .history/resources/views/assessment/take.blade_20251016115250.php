...
<div class="min-h-screen relative">
    ...
    <!-- Subtle Grid Pattern -->
    <div class="absolute inset-0 opacity-[0.02]" style="background-image: radial-gradient(circle at 1px 1px, rgba(255,255,255,0.8) 1px, transparent 0); background-size: 20px 20px;"></div>
    
    <!-- Minimal Accent Elements -->
    <div class="absolute inset-0 overflow-hidden pointer-events-none">
        <div class="absolute -top-40 -right-40 w-80 h-80 bg-blue-500/5 rounded-full blur-3xl"></div>
        <div class="absolute bottom-0 -left-40 w-80 h-80 bg-indigo-500/3 rounded-full blur-3xl"></div>
    </div>    <div class="relative z-10 container mx-auto px-6 max-w-5xl py-8">
