                                        ...
                                        @if($assessment->type === 'ptsd_diagnostic')
                                            ...
                                            <div class="space-y-4">
                                                ...
                                                <label class="answer-option group block relative">
                                                    ...
                                                    <div class="w-full p-6 bg-gradient-to-r from-gray-50 to-gray-25 border-2 border-gray-200 rounded-xl cursor-pointer transition-all duration-300
                                                                peer-checked:from-blue-50 peer-checked:to-blue-25 peer-checked:border-blue-300 peer-checked:shadow-lg peer-checked:shadow-blue-100/50
                                                                hover:border-blue-200 hover:shadow-md group-hover:scale-[1.02] transform">
                                                        <div class="flex items-center space-x-4">
                                                            <!-- Custom Checkbox -->
                                                            <div class="relative">
                                                                <div class="w-6 h-6 border-2 border-gray-300 rounded-lg bg-white transition-all duration-300
                                                                            peer-checked:border-blue-500 peer-checked:bg-blue-500">
                                                                    <svg class="w-4 h-4 text-white absolute top-0.5 left-0.5 opacity-0 peer-checked:opacity-100 transition-opacity duration-300" 
