...
<div class="min-h-screen relative">
    ...
    <div class="relative z-10 container mx-auto px-6 max-w-4xl py-12">
        ...
        <!-- Clean Instructions -->
        <div class="bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 p-6 mb-12" data-aos="fade-up" data-aos-delay="100">
            <div class="flex items-start space-x-4">
                ...
                <div class="flex-1">
                    <h3 class="text-lg font-semibold text-white mb-3">Petunjuk Pengisian</h3>
                    <div class="text-gray-300 leading-relaxed">
                        <p>{{ $questions['instructions'] }}</p>
                    </div>
                </div>
            </div>
        </div>        <!-- Enhanced Assessment Form -->
