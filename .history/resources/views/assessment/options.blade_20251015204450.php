            ...
            <div class="bg-gradient-to-r from-indigo-500 to-purple-600 rounded-xl shadow-lg p-8 text-white" data-aos="fade-up" data-aos-delay="300">
                ...
                <ul class="space-y-2 text-sm opacity-90">
                    <li class="flex items-start">
                        ...
                        <span>Assessment ini dikembangkan oleh Prof. Dr. Nandang Rusmana, M.Pd dan Dr. Juwanto, S.Pd.I., M.Pd untuk tujuan skrining dan bukan diagnosis medis.</span>
                    </li>
                    <li class="flex items-start">
                        <span class="w-2 h-2 bg-white rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    ...
                    <li class="flex items-start">
                        <span class="w-2 h-2 bg-white rounded-full mt-2 mr-3 flex-shrink-0"></span>
                        <span>Jika Anda mengalami distress yang signifikan, silakan konsultasikan dengan profesional kesehatan mental.</span>
                    </li>
                </ul>
            </div>
        </div>
