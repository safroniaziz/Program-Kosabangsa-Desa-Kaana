                                    ...
                                    <div class="bg-gray-50 rounded-xl p-6 border border-gray-200 hover:border-blue-300 transition-colors cursor-pointer" onclick="viewResult({{ $recentAssessment->id }})">
                                        ...
                                        @if(isset($recentAssessment->results['total_score']))
                                            <div class="mt-3 pt-3 border-t border-gray-200">
                                                ...
                                                @if(isset($recentAssessment->results['category_scores']))
                                                    <div class="text-xs">
                                                        <div class="font-medium text-gray-700 mb-2">Keterangan Hambatan Traumatik:</div>
                                                        <div class="space-y-1">
                                                            @php
                                                                $categoryNames = [
                                                                ...
                                                                $scores = $recentAssessment->results['category_scores'];
                                                                arsort($scores); // Sort by score descending
                                                            @endphp
                                                            @foreach($scores as $category => $score)
                                                                <div class="flex justify-between items-center">
                                                                    <span class="text-gray-600">{{ $category }}. {{ $categoryNames[$category] }}</span>
                                                                    <span class="font-medium text-blue-600">Skor: {{ $score }}</span>
                                                                </div>
                                                            @endforeach
                                                        </div>
                                                    </div>
