...
<div class="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-800 relative overflow-hidden">
    ...
    <div class="relative z-10 container mx-auto px-4 py-16 max-w-6xl">
        ...
        <div class="grid md:grid-cols-2 gap-8 mb-12">
            ...
            <div class="group relative" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="relative bg-white/95 backdrop-blur-sm rounded-2xl shadow-xl p-8 hover:bg-white transition-all duration-300 transform hover:-translate-y-2">
                    ...
                    <p class="text-gray-600 mb-6 leading-relaxed">
                        Assessment komprehensif untuk mengevaluasi gejala-gejala PTSD berdasarkan kriteria diagnostik internasional yang terstandar.
                    </p>

                    <!-- Stats -->
                    <div class="grid grid-cols-2 gap-4 mb-6">
                        <div class="bg-blue-50 rounded-lg p-4 text-center group hover:bg-blue-100 transition-colors duration-300">
                            <div class="text-2xl font-bold text-blue-600 mb-1 counter-animate" data-count="20">0</div>
                            <div class="text-xs text-blue-600 font-medium uppercase tracking-wide">Menit</div>
                        </div>
                        <div class="bg-blue-50 rounded-lg p-4 text-center group hover:bg-blue-100 transition-colors duration-300">
                    ...
                    <div class="bg-gradient-to-r from-blue-500/10 to-cyan-500/10 border border-blue-200/50 p-4 rounded-xl mb-6">
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-blue-600 mt-1">Beri tanda silang (X) pada pernyataan yang BENAR bagi Anda</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Action Button -->
                    @auth
                        <a href="{{ route('assessment.mental-health') }}" class="w-full inline-flex items-center justify-center px-6 py-4 bg-gradient-to-r from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 group">
                            <svg class="w-5 h-5 mr-2 group-hover:translate-x-1 transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6"></path>
                            </svg>
                            Mulai Assessment PTSD
                        </a>
                    @else
                        <a href="{{ route('login') }}" class="w-full inline-flex items-center justify-center px-6 py-4 bg-gradient-to-r from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 group">
                            <svg class="w-5 h-5 mr-2 group-hover:translate-x-1 transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="group relative" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="relative bg-white/95 backdrop-blur-sm rounded-2xl shadow-xl p-8 hover:bg-white transition-all duration-300 transform hover:-translate-y-2">
                    ...
                    <p class="text-gray-600 mb-6 leading-relaxed">
                        Checklist komprehensif untuk mengidentifikasi berbagai gejala dan masalah yang mungkin dialami setelah bencana atau trauma.
                    </p>

                    <!-- Stats -->
                    <div class="grid grid-cols-2 gap-4 mb-6">
                        <div class="bg-emerald-50 rounded-lg p-4 text-center group hover:bg-emerald-100 transition-colors duration-300">
                            <div class="text-2xl font-bold text-emerald-600 mb-1 counter-animate" data-count="15">0</div>
                            <div class="text-xs text-emerald-600 font-medium uppercase tracking-wide">Menit</div>
                        </div>
                        <div class="bg-emerald-50 rounded-lg p-4 text-center group hover:bg-emerald-100 transition-colors duration-300">
                    ...
                    <div class="bg-gradient-to-r from-emerald-500/10 to-teal-500/10 border border-emerald-200/50 p-4 rounded-xl mb-6">
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-emerald-600 mt-1">Pilih "Ada" atau "Tidak Ada" untuk setiap gejala yang dialami</p>
                            </div>
                        </div>
                    </div>
                    ...
                    @else
                        <a href="{{ route('login') }}" class="w-full inline-flex items-center justify-center px-6 py-4 bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 group">
                            <svg class="w-5 h-5 mr-2 group-hover:translate-x-1 transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <!-- Information Section -->
        <div class="grid md:grid-cols-3 gap-6 mb-12" data-aos="fade-up" data-aos-delay="400">
            <!-- Feature 1 -->
