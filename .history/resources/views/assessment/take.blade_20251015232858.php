                            ...
                            <div class="category-section bg-gray-50 rounded-xl p-6 border-2 border-gray-200">
                                <div class="mb-6">
                                    ...
                                    <p class="text-sm text-gray-600">
                                        Beri tanda silang (X) pada setiap gejala yang terasa setelah musibah/bencana
                                    </p>
                                </div>
                        ...
                        @foreach($questions['questions'] as $number => $question)
                            ...
                            <div class="ml-14 space-y-3">
                                ...
                                @elseif($assessment->type === 'ptsd_diagnostic')
                                    <!-- PTSD Checkbox format - silang jika BENAR -->
                                    <div class="space-y-4">
                                        <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                                            <p class="text-sm text-blue-700 font-medium">
                                                ...
                                                Beri tanda silang (X) jika pernyataan ini BENAR bagi Anda. Biarkan kosong jika TIDAK BENAR.
                                            </p>
                                        </div>
...
function updateProgress() {
    ...
    @else
        ...
        @if($assessment->type === 'ptsd_diagnostic')
            // For PTSD: all questions are considered answered since user can choose to leave unchecked
...
document.addEventListener('DOMContentLoaded', function() {
    // Enable submit button immediately for PTSD
    const submitButton = document.getElementById('submitButton');
    submitButton.disabled = false;
    submitButton.classList.remove('opacity-50', 'cursor-not-allowed');

    // Set progress to 100% since all questions are optional
    updateProgress();
