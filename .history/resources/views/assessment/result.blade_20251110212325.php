                ...
                <div class="space-y-3">
                    <div class="bg-white rounded-lg p-4">
                        ...
                        <div class="text-gray-700 text-sm space-y-2">
                            ...
                            <p><strong>Skor {{ $results['total_score'] }}</strong> dari total <strong>{{ $assessment->assessment_type === 'ptsd' ? '30' : '69' }}</strong> pertanyaan menunjukkan bahwa {{ $results['risk_level'] ?? 'low' }}.</p>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-lg p-4">
                        ...
                        <div class="text-gray-700 text-sm space-y-2">
                            <p>Hasil assessment mencerminkan bagaimana Anda merespons pada berbagai gejala yang terkait dengan {{ $assessment->type === 'ptsd' ? 'PTSD' : 'DCM' }}.</p>
