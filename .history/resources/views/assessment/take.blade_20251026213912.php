            ...
            <div class="bg-white rounded-3xl shadow-xl border border-gray-100 p-8 md:p-10">
                ...
                <div class="text-center mt-12 pt-8 border-t border-gray-200">
                    <button type="submit"
                            ...
                            @if($assessment->type === 'checklist_masalah'){{ '' }}@else{{ 'disabled' }}@endif>
...
<script>
    ...
    function updateCircularProgress(percent, answeredQuestions = 0, totalQuestions = 0) {
        ...
        @if($assessment->type === 'ptsd_diagnostic')
            // For PTSD: enable submit only after user starts answering (at least 1 answer)
            if (answeredQuestions > 0) {
                ...
                submitButton.classList.add('bg-blue-600', 'hover:bg-blue-700', 'border-blue-600', 'hover:border-blue-700');
            } else {
                ...
                submitButton.classList.remove('bg-blue-600', 'hover:bg-blue-700', 'border-blue-600', 'hover:border-blue-700');
            }
        @else
