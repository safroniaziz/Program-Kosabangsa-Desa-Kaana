    ...
    <div class="relative z-10 container mx-auto px-4 py-16 max-w-6xl">
        ...
        <div class="max-w-4xl mx-auto" data-aos="fade-up" data-aos-delay="500">
            <div class="bg-white/10 backdrop-blur-sm rounded-3xl p-8 border border-white/20">
                <div class="flex items-center justify-center mb-6" data-aos="fade-up" data-aos-delay="550">
                ...
                <div class="grid md:grid-cols-2 gap-6 text-white/90">
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start" data-aos="fade-up" data-aos-delay="700">
                        ...
                        <div class="flex items-start" data-aos="fade-up" data-aos-delay="750">
