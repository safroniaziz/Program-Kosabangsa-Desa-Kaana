            ...
            <div class="bg-white/10 backdrop-blur-3xl rounded-3xl shadow-2xl border border-white/20 p-8 md:p-12 relative overflow-hidden">
                ...
                <div class="mb-10">
                    ...
                    <div class="w-full bg-gradient-to-r from-gray-100 to-gray-50 rounded-full h-2 shadow-inner">
                        <div id="progressBar" class="@if($assessment->type === 'ptsd_diagnostic')bg-gradient-to-r from-blue-400 to-blue-600 @elseif($assessment->type === 'checklist_masalah')bg-gradient-to-r from-emerald-400 to-emerald-600 @elseif($assessment->type === 'pcl5')bg-gradient-to-r from-purple-400 to-purple-600@else bg-gradient-to-r from-gray-400 to-gray-600 @endif h-2 rounded-full transition-all duration-700 ease-out shadow-sm" style="width: 0%"></div>
                    </div>
                </div>
