                                        ...
                                        <div class="mt-3 pt-3 border-t border-gray-200">
                                            ...
                                            @if(isset($recentAssessment->results))
                                                @php
                                                    ...
                                                    $results = $recentAssessment->results;
                                                    ...
                                                    // DCM category names - using numeric keys
                                                    $categoryNames = [
                                                        1 => 'Gejala Fisik',
                                                        2 => 'Gejala Emosi',
                                                        3 => 'Gejala Mental',
                                                ...
                                                <div class="mb-4 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border border-blue-100">
                                                    <div class="flex items-center justify-between text-sm">
                                                        ...
                                                        <div class="text-right">
                                                            <span class="font-bold text-blue-600 text-lg">{{ $totalProblems }}/{{ \App\Models\ChecklistMasalahQuestion::count() }}</span>
                                                            <span class="text-xs text-gray-500 ml-2">({{ round(($totalProblems / \App\Models\ChecklistMasalahQuestion::count()) * 100, 1) }}%)</span>
                                                        </div>
                                                    </div>
                ...
                <div class="h-full flex flex-col">
                    ...
                    <div class="space-y-4 mb-6">
                        <div class="flex items-center justify-between p-4 bg-emerald-50 rounded-lg">
                            <span class="text-gray-700 font-medium">Jumlah Pernyataan:</span>
                            <span class="font-bold text-emerald-600">{{ \App\Models\ChecklistMasalahQuestion::count() }} Pernyataan</span>
                        </div>
