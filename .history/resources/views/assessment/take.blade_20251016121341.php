            ...
            <div class="bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 p-8">
                ...
                <div class="mb-10">
                    ...
                    <div class="w-full bg-white/10 rounded-full h-2">
                        <div id="progressBar" class="bg-gradient-to-r from-white/60 to-white/80 h-2 rounded-full transition-all duration-700 ease-out" style="width: 0%"></div>
                    </div>
                </div>
                ...
                <div class="text-center mt-12 pt-8 border-t border-white/10">
                    <button type="submit"
                            id="submitButton"
                            class="inline-flex items-center justify-center px-8 py-3 bg-white/20 hover:bg-white/30
                            text-white font-medium rounded-xl border border-white/20 hover:border-white/40
