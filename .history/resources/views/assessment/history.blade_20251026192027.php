                            ...
                            @if(isset($userAssessment->results))
                                ...
                                <div class="mb-4 p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl border border-green-200">
                                    ...
                                    <div class="overflow-x-auto">
                                        <table class="w-full text-sm border border-gray-200 rounded-lg table-fixed">
                                            <thead class="bg-gray-50">
                                                <tr>
                                                    <th class="px-3 py-2 text-left font-medium text-gray-700 border-b w-16">Kategori</th>
                                                    <th class="px-3 py-2 text-center font-medium text-gray-700 border-b w-24">Skor</th>
                                                    <th class="px-3 py-2 text-center font-medium text-gray-700 border-b w-16">Rank</th>
                                                    <th class="px-3 py-2 text-left font-medium text-gray-700 border-b">Jenis Hambatan</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                @php
                                                    $categoryNames = [
                                                        'A' => 'Terbayangi Traumatis',
