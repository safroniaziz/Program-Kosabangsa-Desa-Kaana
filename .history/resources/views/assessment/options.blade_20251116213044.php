            ...
            <div class="group relative" data-aos="fade-up" data-aos-delay="{{ ($index + 1) * 100 }}">
                ...
                <div class="relative bg-white/95 backdrop-blur-sm rounded-2xl shadow-xl p-8 hover:bg-white transition-all duration-300 transform hover:-translate-y-2">
                    ...
                    <p class="text-gray-600 mb-6 leading-relaxed">
                        @if($assessment->type === 'ptsd' || $assessment->type === 'ptsd_diagnostic')
                            Instrumen diagnostik untuk mengevaluasi gejala Post-Traumatic Stress Disorder (PTSD) berdasarkan kriteria diagnostik yang terstandar. Assessment ini membantu mengidentifikasi gejala trauma pasca peristiwa traumatis.
                        @elseif($assessment->type === 'checklist_masalah')
                            Daftar cek masalah pasca bencana untuk mengidentifikasi berbagai gejala dan dampak psikologis yang muncul setelah mengalami bencana. Assessment ini mencakup 5 kategori gejala: fisik, emosi, mental, perilaku, dan spiritual.
                        @else
                            Assessment untuk mengevaluasi gejala-gejala terkait kesehatan mental berdasarkan kriteria diagnostik yang terstandar.
                        @endif
                    </p>
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-6">
                        ...
                        <div class="bg-emerald-50 rounded-lg p-4 text-center group hover:bg-emerald-100 transition-colors duration-300">
                            <div class="text-2xl font-bold text-emerald-600 mb-1 counter-animate" data-count="100">0</div>
                    ...
                    <div class="bg-gradient-to-r from-emerald-500/10 to-teal-500/10 border border-emerald-200/50 p-4 rounded-xl mb-6">
                        <div class="flex items-start">
                            ...
                            <div>
                                <p class="text-sm text-emerald-800 font-medium">Format Checkbox</p>
                                <p class="text-xs text-emerald-600 mt-1">Centang gejala yang Anda rasakan setelah bencana</p>
                            </div>
                        </div>
                    </div>
                    @endif
