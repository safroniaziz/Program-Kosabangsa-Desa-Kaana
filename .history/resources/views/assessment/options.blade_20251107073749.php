...
<script>
// Chat Functions - redirect ke halaman assessment yang memiliki chat lengkap
function openChatConseling() {
    // Redirect ke halaman assessment utama yang memiliki chat container lengkap
    window.location.href = '{{ route("assessment") }}?openChat=true';
}
</script>
@endsection
