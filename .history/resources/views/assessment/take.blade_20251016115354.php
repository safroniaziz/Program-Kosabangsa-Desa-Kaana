...
<div class="min-h-screen relative">
    ...
    <div class="relative z-10 container mx-auto px-6 max-w-4xl py-12">
        <!-- Clean Minimal Header -->
        <div class="text-center mb-16" data-aos="fade-up">
            <!-- Simple Icon -->
            <div class="inline-flex items-center justify-center w-16 h-16 bg-white/5 backdrop-blur-sm rounded-2xl shadow-lg mb-8 border border-white/10">
            ...
            <!-- Clean Title -->
            <h1 class="text-4xl font-semibold text-white mb-8 leading-tight tracking-tight">
                {{ $assessment->name }}
            </h1>
