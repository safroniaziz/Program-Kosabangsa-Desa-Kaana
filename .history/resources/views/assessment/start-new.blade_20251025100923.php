                                    ...
                                    <div class="bg-gray-50 rounded-xl p-6 border border-gray-200 hover:border-blue-300 transition-colors cursor-pointer" onclick="viewResult({{ $recentAssessment->id }})">
                                        <div class="flex items-start justify-between mb-3">
                                            ...
                                            <div class="flex items-center space-x-2">
                                                ...
                                                @elseif($recentAssessment->overall_risk_level === 'mild')
                                                ...
                                                @endif
                                                <!-- Debug info -->
                                                <span class="text-xs text-gray-400">({{ $recentAssessment->overall_risk_level ?? 'null' }})</span>
                                                @if(isset($recentAssessment->results['risk_level']))
                                                    <span class="text-xs text-gray-400">[{{ $recentAssessment->results['risk_level'] }}]</span>
                                                @endif
                                            </div>
                                        </div>
