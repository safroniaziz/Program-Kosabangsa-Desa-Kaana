...
@section('title', 'Riwayat Assessment PTSD')
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-8">
            <div class="flex items-center justify-center mb-4">
                ...
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">Riwayat Assessment PTSD</h1>
        ...
        <!-- Back Button -->
        <div class="mb-6">
            <a href="{{ route('assessment.start-new', 1) }}"
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex items-start justify-between mb-4">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        <h3 class="text-xl font-semibold text-gray-900">Assessment #{{ $assessment->id }}</h3>
                                        <p class="text-sm text-gray-600">{{ $assessment->completed_at->format('d F Y - H.i') }}</p>
                                    </div>
                                </div>
                                <div class="flex items-center space-x-2">
                                    <span class="px-3 py-1 bg-blue-100 text-blue-700 text-sm font-medium rounded-full">Assessment PTSD</span>
                                </div>
                            </div>

                            <!-- Assessment Results -->
                            @if(isset($assessment->results))
                                <div class="mb-4">
                                    <div class="flex items-center justify-between text-sm mb-3">
                                        <span class="text-gray-600">Skor Total:</span>
                                        <span class="font-bold text-blue-600">{{ $assessment->results['total_score'] ?? 0 }}/30</span>
                                    </div>
                                        ...
                                        <table class="w-full text-sm border border-gray-200 rounded-lg">
                                            ...
                                            <tbody>
                                                @php
                                                    ...
                                                    $scores = $assessment->results['category_scores'] ?? [];
                                                    $sortedScores = $scores;
                                                    arsort($sortedScores);
                                                    $ranking = 1;
                                                @endphp
                            ...
                            <div class="flex justify-end space-x-3 pt-4 border-t border-gray-200">
                                <button onclick="viewResult({{ $assessment->id }})"
