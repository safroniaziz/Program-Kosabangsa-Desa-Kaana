...
<div class="min-h-screen relative overflow-hidden">
    ...
    <div class="absolute inset-0 bg-gradient-to-br from-indigo-900 via-purple-800 to-pink-700 opacity-90"></div>
    <div class="absolute inset-0 bg-gradient-to-tl from-blue-600/30 via-transparent to-cyan-500/20"></div>

    <!-- Floating Particles Animation -->
    <div class="absolute inset-0 overflow-hidden pointer-events-none">
        <div class="absolute -top-40 -right-32 w-80 h-80 bg-gradient-to-br from-blue-400/20 to-purple-500/20 rounded-full blur-3xl animate-pulse"></div>
        <div class="absolute top-40 -left-32 w-96 h-96 bg-gradient-to-br from-pink-400/15 to-orange-500/15 rounded-full blur-3xl animate-pulse delay-1000"></div>
        <div class="absolute bottom-20 right-20 w-64 h-64 bg-gradient-to-br from-cyan-400/20 to-blue-500/20 rounded-full blur-2xl animate-bounce"></div>

        <!-- Floating Geometric Shapes -->
        <div class="absolute top-1/4 left-1/4 w-4 h-4 bg-white/10 rotate-45 animate-spin" style="animation-duration: 8s;"></div>
        <div class="absolute top-3/4 right-1/3 w-6 h-6 bg-cyan-300/20 rounded-full animate-ping" style="animation-duration: 4s;"></div>
        <div class="absolute top-1/2 left-2/3 w-3 h-3 bg-pink-400/30 rotate-12 animate-pulse"></div>
    </div>

    <div class="relative z-10 container mx-auto px-6 max-w-5xl py-8">
        <!-- Enhanced Header with Glass Effect -->
        <div class="text-center mb-12" data-aos="fade-up">
            <!-- Icon with Glow Effect -->
            <div class="inline-flex items-center justify-center w-20 h-20 bg-white/10 backdrop-blur-xl rounded-3xl shadow-2xl mb-8 border border-white/20 relative">
                <div class="absolute inset-0 bg-gradient-to-br from-blue-400/20 to-purple-500/20 rounded-3xl blur-xl"></div>
            ...
            <h1 class="text-5xl md:text-6xl font-black text-white mb-6 leading-tight">
                <span class="bg-clip-text text-transparent bg-gradient-to-r from-cyan-300 via-blue-300 to-purple-300 animate-pulse">
                    {{ $assessment->name }}
                </span>
            </h1>

            <!-- Enhanced Info Cards -->
            <div class="flex justify-center items-center space-x-6 text-white/90 flex-wrap gap-4">
                <div class="flex items-center bg-white/10 backdrop-blur-md rounded-2xl px-6 py-3 shadow-xl border border-white/20 hover:bg-white/20 transition-all duration-300 transform hover:scale-105">
                    <div class="w-10 h-10 bg-gradient-to-br from-amber-400 to-orange-500 rounded-full flex items-center justify-center mr-3 animate-pulse">
                        <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                        </svg>
                    </div>
                    <div class="text-left">
                        <div class="text-xs text-white/70 font-medium">Durasi</div>
                        <div class="font-bold text-lg">{{ $assessment->time_limit_minutes }} menit</div>
                    </div>
                </div>

                <div class="flex items-center bg-white/10 backdrop-blur-md rounded-2xl px-6 py-3 shadow-xl border border-white/20 hover:bg-white/20 transition-all duration-300 transform hover:scale-105">
                    <div class="w-10 h-10 bg-gradient-to-br from-blue-400 to-indigo-500 rounded-full flex items-center justify-center mr-3 animate-pulse delay-500">
                        <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                        </svg>
                    </div>
                    <div class="text-left">
                        <div class="text-xs text-white/70 font-medium">Total</div>
                        <div class="font-bold text-lg">{{ $assessment->total_questions }} pertanyaan</div>
                    </div>
                </div>
            </div>
        </div>

        <!-- Enhanced Instructions with Glass Effect -->
        <div class="bg-white/15 backdrop-blur-2xl rounded-3xl shadow-2xl border border-white/20 p-8 mb-12 relative overflow-hidden" data-aos="fade-up" data-aos-delay="100">
            <!-- Background Pattern -->
            <div class="absolute inset-0 bg-gradient-to-r from-blue-500/5 to-purple-500/5"></div>
            <div class="absolute top-0 right-0 w-32 h-32 bg-gradient-to-bl from-cyan-300/10 to-transparent rounded-full blur-2xl"></div>

            <div class="relative z-10 flex items-start space-x-6">
                <div class="flex-shrink-0">
                    <div class="w-14 h-14 bg-gradient-to-br from-cyan-400 to-blue-500 rounded-2xl flex items-center justify-center shadow-xl relative">
                        <div class="absolute inset-0 bg-gradient-to-br from-cyan-400/50 to-blue-500/50 rounded-2xl blur-lg"></div>
                        <svg class="h-7 w-7 text-white relative z-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="flex-1">
                    <h3 class="text-2xl font-bold text-white mb-4 flex items-center">
                        <span class="bg-clip-text text-transparent bg-gradient-to-r from-cyan-300 to-blue-300">Petunjuk Pengisian</span>
                        <div class="ml-3 w-2 h-2 bg-cyan-400 rounded-full animate-pulse"></div>
                    </h3>
        ...
        <form action="@if($assessment->type === 'checklist_masalah') {{ route('assessment.submit-dcm', $assessment) }} @else {{ route('assessment.submit', $assessment) }} @endif" method="POST" id="assessmentForm" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="bg-white/10 backdrop-blur-3xl rounded-3xl shadow-2xl border border-white/20 p-8 md:p-12 relative overflow-hidden">
                <!-- Decorative Elements -->
                <div class="absolute top-0 left-0 w-40 h-40 bg-gradient-to-br from-pink-400/10 to-transparent rounded-full blur-3xl"></div>
                <div class="absolute bottom-0 right-0 w-60 h-60 bg-gradient-to-tl from-blue-400/10 to-transparent rounded-full blur-3xl"></div>
                <!-- Enhanced Progress Bar with Animated Elements -->
                <div class="mb-12 relative z-10">
                    <div class="flex justify-between items-center mb-6">
                        <div class="flex items-center space-x-3">
                            <h3 class="text-2xl font-bold text-white">Progress Assessment</h3>
                            <div class="w-3 h-3 bg-gradient-to-r from-cyan-400 to-blue-400 rounded-full animate-pulse"></div>
                        </div>
                        <div class="flex items-center space-x-4">
                            <!-- Enhanced Progress Counter -->
                            <div class="bg-white/10 backdrop-blur-md rounded-2xl px-4 py-2 border border-white/20">
                                <span id="progressText" class="text-sm font-bold text-white">
                            ...
                            <div class="w-20 h-20 relative">
                                <div class="absolute inset-0 bg-gradient-to-br from-cyan-400/20 to-blue-500/20 rounded-full blur-lg animate-pulse"></div>
                                ...
                                <div class="absolute inset-0 flex items-center justify-center">
                                    <span id="progressPercent" class="text-sm font-bold text-white drop-shadow-lg">0%</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="relative">
                        <div class="w-full bg-white/10 backdrop-blur-md rounded-full h-3 shadow-inner border border-white/20">
                            <div id="progressBar" class="@if($assessment->type === 'ptsd_diagnostic')bg-gradient-to-r from-cyan-400 to-blue-500 @elseif($assessment->type === 'checklist_masalah')bg-gradient-to-r from-emerald-400 to-green-500 @elseif($assessment->type === 'pcl5')bg-gradient-to-r from-purple-400 to-violet-500@else bg-gradient-to-r from-gray-400 to-gray-600 @endif h-3 rounded-full transition-all duration-1000 ease-out shadow-lg relative overflow-hidden" style="width: 0%">
                                <!-- Shimmer Effect -->
            ...
            <div class="relative z-10 flex items-start space-x-6">
                ...
                <div class="flex-1">
                    <h3 class="text-xl font-bold text-white mb-3 flex items-center">
                        <span class="bg-clip-text text-transparent bg-gradient-to-r from-amber-300 to-orange-300">Penting untuk Diketahui</span>
                        <div class="ml-2 w-2 h-2 bg-amber-400 rounded-full animate-ping"></div>
                    </h3>
        ...
        <div id="successAnimation" class="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 hidden items-center justify-center">
            <div class="bg-white/10 backdrop-blur-xl rounded-3xl p-12 text-center border border-white/20 shadow-2xl">
                ...
                <h3 class="text-3xl font-bold text-white mb-4">Assessment Selesai!</h3>
                <p class="text-white/80 text-lg">Terima kasih atas partisipasi Anda</p>
                <div class="animate-pulse mt-4">
                    <div class="w-8 h-1 bg-gradient-to-r from-cyan-400 to-blue-500 rounded-full mx-auto"></div>
                </div>
            </div>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Add entrance animations to question blocks
    ...
    // Observe all question blocks for animation
