...
<div class="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-800 relative overflow-hidden">
    ...
    <div class="relative z-10 container mx-auto px-4 py-16 max-w-6xl">
        ...
        <div class="grid md:grid-cols-2 gap-8 mb-12">
            ...
            <div class="group relative" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="relative bg-white/95 backdrop-blur-sm rounded-2xl shadow-xl p-8 hover:bg-white transition-all duration-300 transform hover:-translate-y-2">
                    ...
                    <!-- Action Button -->
                    @auth
                        <a href="{{ route('assessment.start', 1) }}" class="btn-assessment w-full inline-flex items-center justify-center px-6 py-4 bg-gradient-to-r from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 group">
            ...
            <div class="group relative" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="relative bg-white/95 backdrop-blur-sm rounded-2xl shadow-xl p-8 hover:bg-white transition-all duration-300 transform hover:-translate-y-2">
                    ...
                    <h3 class="text-2xl font-bold text-gray-800 mb-4 leading-tight">
                        Instrumen Kriteria Diagnostik DCM
                    </h3>

                    <p class="text-gray-600 mb-6 leading-relaxed">
                        Assessment untuk mengevaluasi gejala-gejala terkait Daftar Cek Masalah (DCM) berdasarkan kriteria diagnostik yang terstandar.
                    </p>                    <!-- Stats -->
                    <div class="grid grid-cols-2 gap-4 mb-6">
                    ...
                    <!-- Action Button -->
                    @auth
                        <a href="{{ route('assessment.start', 3) }}" class="btn-assessment w-full inline-flex items-center justify-center px-6 py-4 bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 group">
                            <svg class="w-5 h-5 mr-2 group-hover:translate-x-1 transition-transform duration-200 icon-bounce" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6"></path>
                            </svg>
                            <span>Mulai Assessment DCM</span>
                        </a>
                    @else
                        <a href="{{ route('login') }}" class="btn-assessment w-full inline-flex items-center justify-center px-6 py-4 bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 group">
                            <svg class="w-5 h-5 mr-2 group-hover:translate-x-1 transition-transform duration-200 icon-bounce" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <!-- Information Section -->
        <div class="grid md:grid-cols-3 gap-6 mb-12" data-aos="fade-up" data-aos-delay="300">
            <!-- Feature 1 -->
        ...
        <div class="max-w-4xl mx-auto" data-aos="fade-up" data-aos-delay="600">
            <div class="bg-white/10 backdrop-blur-sm rounded-3xl p-8 border border-white/20">
                <div class="flex items-center justify-center mb-6" data-aos="fade-up" data-aos-delay="700">
                ...
                <div class="grid md:grid-cols-2 gap-6 text-white/90">
                    <div class="space-y-4">
                        <div class="flex items-start" data-aos="fade-up" data-aos-delay="800">
                        ...
                        <div class="flex items-start" data-aos="fade-up" data-aos-delay="900">
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start" data-aos="fade-up" data-aos-delay="1000">
                        ...
                        <div class="flex items-start" data-aos="fade-up" data-aos-delay="1100">
