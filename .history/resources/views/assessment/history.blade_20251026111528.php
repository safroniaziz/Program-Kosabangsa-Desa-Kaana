                    ...
                    <div class="bg-white rounded-2xl shadow-lg border border-gray-200 hover:shadow-xl transition-all duration-300 overflow-hidden">
                        <div class="p-6">
                            ...
                            @if(isset($userAssessment->results))
                                <div class="mb-4">
                                    <div class="flex items-center justify-between text-sm mb-3">
                                        ...
                                        <span class="font-bold text-blue-600">{{ $userAssessment->results['total_score'] ?? 0 }}/30</span>
                                    </div>
                                        ...
                                        <table class="w-full text-sm border border-gray-200 rounded-lg">
                                            ...
                                            <tbody>
                                                @php
                                                    ...
                                                    $scores = $userAssessment->results['category_scores'] ?? [];
                                                    $sortedScores = $scores;
                                                    arsort($sortedScores);
                                                    $ranking = 1;
                                                @endphp
                            ...
                            <div class="flex justify-end space-x-3 pt-4 border-t border-gray-200">
                                        <button onclick="viewResult({{ $userAssessment->id }})"
