                                                    ...
                                                    <div class="w-full p-6 bg-gradient-to-r from-slate-50 to-gray-50 border-2 border-gray-200 rounded-xl cursor-pointer transition-all duration-300
                                                        ...
                                                        <div class="flex items-center space-x-4">
                                                            ...
                                                            <div class="relative flex-shrink-0">
                                                                <div class="w-7 h-7 border-2 border-gray-300 rounded-lg bg-white transition-all duration-300 peer-checked:border-blue-500 peer-checked:bg-blue-500 shadow-sm relative">
                                                                    <svg class="w-5 h-5 text-white absolute top-0.5 left-0.5 opacity-0 peer-checked:opacity-100 transition-all duration-300 transform peer-checked:scale-110"
