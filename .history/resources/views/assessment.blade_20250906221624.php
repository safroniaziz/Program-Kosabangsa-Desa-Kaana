    ...
    function showResults(score) {
        ...
        const resultsHTML = `
            ...
            <div class="flex items-center justify-between p-6 border-b border-gray-200">
                <h2 class="text-xl font-bold text-gray-900">Hasil Assessment</h2>
            ...
            <div class="flex-1 overflow-y-auto px-6 py-4">
                ...
                <div class="text-center mb-6">
                    <div class="status-indicator ${statusClass} mx-auto">
                        <span>${statusIcon}</span>
                    </div>
                    <h3 class="text-2xl font-bold text-gray-900 mb-2">${status}</h3>
                    <p class="text-base text-gray-600 font-medium">${recommendation}</p>
                </div>
                ...
                <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-4 mb-6 border border-blue-100">
                    <div class="grid grid-cols-3 gap-4 text-center">
                        <div class="bg-white rounded-lg p-3 shadow-sm">
                            <div class="text-2xl font-bold text-blue-600">${Math.round((score/4) * 100)}%</div>
                        ...
                        <div class="bg-white rounded-lg p-3 shadow-sm">
                            ...
                            <div class="text-xs text-gray-600 font-medium">Soal</div>
                        </div>
                        <div class="bg-white rounded-lg p-3 shadow-sm">
                            <div class="text-2xl font-bold text-purple-600">${assessmentData.sections.length}</div>
                            <div class="text-xs text-gray-600 font-medium">Bagian</div>
                        </div>
                    </div>
                </div>

                <!-- Description -->
                <div class="text-center text-sm text-gray-700 leading-relaxed mb-6 px-4">
                ...
                ${needsCounseling ? `
                    <div class="recommendation-card">
                        ...
                        <h3 class="text-base font-bold text-orange-900 mb-2 text-center">💬 Konsultasi Virtual</h3>
                        <p class="text-orange-800 text-center text-sm">
                            Disarankan berkonsultasi dengan konselor profesional untuk mendapatkan panduan yang lebih personal.
                        </p>
                    </div>
                ` : `
                    <div class="recommendation-card-success">
                        ...
                        <h3 class="text-base font-bold text-green-900 mb-2 text-center">🎉 Luar Biasa!</h3>
                        <p class="text-green-800 text-center text-sm">
                            Kesiapan mental Anda sudah sangat baik. Pertahankan kondisi ini!
                        </p>
                    </div>
                `}
            </div>
            ...
            <!-- Modal Footer (Fixed) -->
            <div class="border-t border-gray-200 bg-gray-50 rounded-b-2xl p-6">
                <div class="space-y-4">
                    <button onclick="downloadPDFReport()" class="modal-button-primary">
                    ...
                    ${needsCounseling ? `
                        <button onclick="openChatConseling(); closeModal();" class="modal-button-secondary">
                            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"/>
                            </svg>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <button onclick="window.location.href='/'" class="modal-button-small">
                            <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/>
                            </svg>
                            <span class="text-responsive">Beranda</span>
                            <span class="text-mobile hidden">Home</span>
                        </button>
                        <button onclick="location.reload()" class="modal-button-outline">
                            <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
