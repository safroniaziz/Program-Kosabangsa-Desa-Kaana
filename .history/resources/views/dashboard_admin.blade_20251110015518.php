        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="row g-5 g-xl-8 mb-8">
                ...
                <div class="col-xl-3 col-md-6">
                    <x-dashboard-stats-card
                        title="Posyandu"
                        :value="$stats['total_posyandu']"
                        icon="ki-duotone ki-first-aid"
                        color="dark"
                        percentage="78"
                        description="Pos pelayanan kesehatan anak"
                    />
                </div>
                ...
                <div class="col-xl-3 col-md-6">
                    <x-dashboard-stats-card
                        title="Total Rumah"
                        :value="$stats['total_rumah']"
                        icon="ki-duotone ki-home"
                        color="success"
                        percentage="65"
                        description="Rumah tangga terdata"
                    />
                </div>
                ...
                <div class="col-xl-3 col-md-6">
                    <x-dashboard-stats-card
                        ...
                        icon="ki-duotone ki-users"
                        color="primary"
                        :percentage="$performanceMetrics['participation_rate']"
                        description="KK terdaftar dalam sistem"
                    />
                </div>
            </div>
            ...
            <div class="row g-5 g-xl-8 mb-8">
                ...
                <div class="col-xl-4">
                    <div class="card card-flush border-0 bg-white shadow-sm h-100">
                        <div class="card-header pt-5">
                            <h3 class="card-title fw-bold text-dark">Tingkat Risiko</h3>
                        </div>
                        <div class="card-body pt-0">
                        ...
                        <div class="card-body pt-0">
                            <div class="d-flex flex-column gap-4">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="d-flex justify-content-between align-items-center mb-1">
                                            <span class="fw-semibold text-gray-800">Coverage Area</span>
                                            <span class="fw-bold text-primary">{{ $performanceMetrics['coverage_rate'] }}%</span>
                                        </div>
                                        <div class="text-gray-600 fs-8 mb-2">Area yang tercover koordinat</div>
                                        <div class="progress h-6px w-100">
                                            <div class="progress-bar bg-primary" style="width: {{ $performanceMetrics['coverage_rate'] }}%"></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="d-flex justify-content-between align-items-center mb-1">
                                            <span class="fw-semibold text-gray-800">Tingkat Respon</span>
                                            <span class="fw-bold text-warning">{{ $performanceMetrics['response_rate'] }}%</span>
                                        </div>
                                        <div class="text-gray-600 fs-8 mb-2">Warga yang merespon assessment</div>
                                        <div class="progress h-6px w-100">
                                            <div class="progress-bar bg-warning" style="width: {{ $performanceMetrics['response_rate'] }}%"></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <div class="text-gray-600 fs-8 mb-2">Warga yang login dalam 7 hari terakhir</div>
                                        <div class="progress h-6px w-100">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Fasilitas Kesehatan Chart
    const fasilitasCtx = document.getElementById('jenisUnitKerjaChart').getContext('2d');
