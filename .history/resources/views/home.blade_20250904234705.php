...
<section class="relative min-h-screen flex items-center justify-center overflow-hidden">
    ...
    <div class="absolute inset-0 z-0">
        <div class="absolute inset-0 bg-gradient-to-br from-blue-900/80 via-purple-900/70 to-green-900/80 z-10"></div>
    ...
    <div class="relative z-20 text-center text-white px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        ...
        <p class="text-xl md:text-2xl mb-8 text-gray-200 leading-relaxed animate-slide-up opacity-90">
            Desa Modern dengan Teknologi Terdepan untuk Pelayanan Masyarakat yang Lebih Baik
        </p>
        <div class="flex flex-col sm:flex-row gap-4 justify-center animate-slide-up">
            <a href="#features" class="btn-primary text-white px-8 py-4 rounded-xl font-semibold text-lg inline-flex items-center justify-center hover:scale-105 transition-transform">
