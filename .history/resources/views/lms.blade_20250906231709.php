                ...
                <div class="space-y-8">
                    ...
                    <div data-aos="fade-up" data-aos-delay="100">
                        <div class="inline-flex items-center gap-3 bg-white/10 backdrop-blur-sm px-6 py-3 rounded-full text-white border border-white/20">
                            ...
                            <span class="text-sm font-semibold">Program Terlengkap • 80+ Jam Pembelajaran • Ekonomi Maritim & Perikanan</span>
                        </div>
                    </div>
                    ...
                    <div data-aos="fade-up" data-aos-delay="300">
                        <p class="text-xl text-gray-200 mb-8 leading-relaxed">
                            Pelajari seluruh aspek <span class="text-blue-400 font-semibold">ekonomi maritim dan perikanan</span>,
                            mulai dari <span class="text-indigo-400 font-semibold">budidaya ikan hingga pengolahan hasil laut</span> untuk
                            <span class="text-cyan-400 font-semibold">membangun bisnis maritim</span> yang berkelanjutan dan menguntungkan.
                        </p>
                    </div>
