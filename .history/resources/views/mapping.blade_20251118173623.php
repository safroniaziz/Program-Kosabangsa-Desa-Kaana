            ...
            <div class="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <div class="chart-container" data-aos="fade-right" data-aos-delay="120">
                        ...
                        <div class="flex items-end justify-between min-h-[15rem] p-6 bg-slate-50 rounded-xl mb-6 overflow-x-auto">
                            @forelse($orderedEducation as $education)
                                ...
                                <div class="flex flex-col items-center gap-2 px-2">
                                    <div class="relative w-16 bg-slate-200 rounded-t h-48">
                                        <div class="absolute bottom-0 left-0 w-full rounded-t" style="height: {{ $barHeight }}%; background-color: {{ $barColor }};"></div>
                                        <span class="absolute -top-8 left-1/2 -translate-x-1/2 text-sm font-semibold text-slate-700">{{ number_format($education['value']) }}</span>
                                    </div>
