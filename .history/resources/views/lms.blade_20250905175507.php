...
<section class="relative min-h-screen overflow-hidden">
    ...
    <div class="container mx-auto px-4 relative z-10 min-h-screen flex items-center">
        <!-- AOS Test Elements - More Visible -->
        <div data-aos="fade-in" class="absolute top-4 left-4 bg-green-500 text-white px-4 py-2 rounded-lg text-sm font-bold z-50 shadow-lg">
            ✅ AOS Test
        </div>
        
        <div data-aos="fade-up" data-aos-delay="100" class="absolute top-4 right-4 bg-blue-500 text-white px-4 py-2 rounded-lg text-sm font-bold z-50 shadow-lg">
            🎯 AOS Working
        </div>
        
        <div data-aos="slide-in-left" data-aos-delay="200" class="absolute top-16 left-4 bg-purple-500 text-white px-4 py-2 rounded-lg text-sm font-bold z-50 shadow-lg">
            🚀 AOS Slide
        </div>
        
        <div data-aos="zoom-in" data-aos-delay="300" class="absolute top-16 right-4 bg-red-500 text-white px-4 py-2 rounded-lg text-sm font-bold z-50 shadow-lg">
            ⚡ AOS Zoom
        </div>
...
<!-- AOS Debug Script -->
<script src="{{ asset('js/aos-debug.js') }}"></script>
<!-- Simple AOS Test -->
<script src="{{ asset('js/aos-simple-test.js') }}"></script>
<script>
...
// Final AOS test - most reliable
window.addEventListener('load', function() {
    console.log('🌐 Window fully loaded, final AOS test...');
    
    setTimeout(function() {
        if (typeof AOS !== 'undefined') {
            console.log('✅ Final AOS test - AOS available');
            ...
            // Refresh
            AOS.refresh();
            console.log('🎉 Final AOS initialization complete!');
            
            // Count and log elements
            const elements = document.querySelectorAll('[data-aos]');
            console.log(`📊 Final test found ${elements.length} AOS elements`);
            
            // Test first few elements manually
            ...
            console.log('❌ Final AOS test - AOS not available');
        }
    }, 1000);
});
</script>
