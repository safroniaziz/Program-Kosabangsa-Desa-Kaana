            ...
            <div class="chart-container" data-aos="fade-right">
                ...
                <div class="flex items-end justify-between h-64 p-4 bg-gray-50 rounded-xl mb-6">
                    <div class="flex flex-col items-center group">
                        <div class="relative w-12 bg-gray-200 rounded-t" style="height: 12%;">
                            <div class="absolute bottom-0 left-0 w-full bg-gradient-to-t from-red-500 to-red-400 rounded-t transition-all duration-500 group-hover:from-red-600 group-hover:to-red-500" style="height: 100%;"></div>
                    ...
                    <div class="flex flex-col items-center group">
                        <div class="relative w-12 bg-gray-200 rounded-t" style="height: 24%;">
                            <div class="absolute bottom-0 left-0 w-full bg-gradient-to-t from-orange-500 to-orange-400 rounded-t transition-all duration-500 group-hover:from-orange-600 group-hover:to-orange-500" style="height: 100%;"></div>
                    ...
                    <div class="flex flex-col items-center group">
                        <div class="relative w-12 bg-gray-200 rounded-t" style="height: 32%;">
                            <div class="absolute bottom-0 left-0 w-full bg-gradient-to-t from-yellow-500 to-yellow-400 rounded-t transition-all duration-500 group-hover:from-yellow-600 group-hover:to-yellow-500" style="height: 100%;"></div>
                    ...
                    <div class="flex flex-col items-center group">
                        <div class="relative w-12 bg-gray-200 rounded-t" style="height: 24%;">
                            <div class="absolute bottom-0 left-0 w-full bg-gradient-to-t from-green-500 to-green-400 rounded-t transition-all duration-500 group-hover:from-green-600 group-hover:to-green-500" style="height: 100%;"></div>
                            <div class="absolute -top-8 left-1/2 transform -translate-x-1/2 text-xs font-semibold text-gray-700">300</div>
                        </div>
                    ...
                    <div class="flex flex-col items-center group">
                        <div class="relative w-12 bg-gray-200 rounded-t" style="height: 6%;">
                            <div class="absolute bottom-0 left-0 w-full bg-gradient-to-t from-blue-500 to-blue-400 rounded-t transition-all duration-500 group-hover:from-blue-600 group-hover:to-blue-500" style="height: 100%;"></div>
                    ...
                    <div class="flex flex-col items-center group">
                        <div class="relative w-12 bg-gray-200 rounded-t" style="height: 2%;">
                            <div class="absolute bottom-0 left-0 w-full bg-gradient-to-t from-purple-500 to-purple-400 rounded-t transition-all duration-500 group-hover:from-purple-600 group-hover:to-purple-500" style="height: 100%;"></div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
            ...
            <div class="chart-container" data-aos="fade-right" data-aos-delay="800">
                ...
                <div class="flex items-end justify-between h-56 p-4 bg-gray-50 rounded-xl mb-6">
                    <div class="flex flex-col items-center group">
                        <div class="relative w-16 bg-gray-200 rounded-t" style="height: 95%;">
                            <div class="absolute bottom-0 left-0 w-full bg-gradient-to-t from-green-500 to-green-400 rounded-t transition-all duration-700 group-hover:from-green-600 group-hover:to-green-500" style="height: 100%;"></div>
                    ...
                    <div class="flex flex-col items-center group">
                        <div class="relative w-16 bg-gray-200 rounded-t" style="height: 98%;">
                            <div class="absolute bottom-0 left-0 w-full bg-gradient-to-t from-blue-500 to-blue-400 rounded-t transition-all duration-700 group-hover:from-blue-600 group-hover:to-blue-500" style="height: 100%;"></div>
                    ...
                    <div class="flex flex-col items-center group">
                        <div class="relative w-16 bg-gray-200 rounded-t" style="height: 92%;">
                            <div class="absolute bottom-0 left-0 w-full bg-gradient-to-t from-yellow-500 to-yellow-400 rounded-t transition-all duration-700 group-hover:from-yellow-600 group-hover:to-yellow-500" style="height: 100%;"></div>
                    ...
                    <div class="flex flex-col items-center group">
                        <div class="relative w-16 bg-gray-200 rounded-t" style="height: 88%;">
                            <div class="absolute bottom-0 left-0 w-full bg-gradient-to-t from-red-500 to-red-400 rounded-t transition-all duration-700 group-hover:from-red-600 group-hover:to-red-500" style="height: 100%;"></div>
