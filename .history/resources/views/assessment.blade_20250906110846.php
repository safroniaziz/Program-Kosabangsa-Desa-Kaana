...
#floatingChatBtn .group:hover .absolute {
    z-index: 1000;
}
...
/* Alternative: If back to top uses specific class name */
.btn-back-to-top {
    bottom: 110px !important;
    z-index: 998 !important;
}

/* If using scroll-to-top class */
.scroll-to-top {
    bottom: 110px !important;
    z-index: 998 !important;
}

/* Generic floating button adjustments */
[class*="back-to-top"],
[class*="scroll-top"],
[id*="backToTop"],
[id*="scrollTop"] {
