...
@section('content')
<!-- Hero Section -->
<section class="py-20 bg-gradient-to-br from-green-600 to-teal-700">
    <div class="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
        <h1 class="text-4xl md:text-5xl font-bold text-white mb-6 animate-fade-in">
            Learning Management System
        </h1>
        <p class="text-xl text-green-100 mb-8 animate-slide-up">
            Platform pembelajaran digital untuk mengembangkan keterampilan dan kompetensi masyarakat Desa Kaana.
        </p>
        <div class="flex justify-center space-x-6 text-green-100 animate-slide-up">
            <div class="text-center">
                <div class="text-3xl font-bold">50+</div>
                <div class="text-sm">Kursus</div>
            </div>
            <div class="text-center">
                <div class="text-3xl font-bold">1,200+</div>
                <div class="text-sm">Peserta</div>
            </div>
            <div class="text-center">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col md:flex-row gap-4 items-center justify-between">
            <div class="flex-1 max-w-md">
                <div class="relative">
                    <input type="text" id="searchCourses" placeholder="Cari kursus..." class="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent">
