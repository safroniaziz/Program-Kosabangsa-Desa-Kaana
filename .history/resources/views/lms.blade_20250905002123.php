        ...
        <div class="glass-card rounded-3xl p-8 shadow-2xl">
            <div class="flex flex-col lg:flex-row gap-8 items-center justify-between">
                ...
                <div class="flex flex-wrap gap-4">
                    <select id="categoryFilter" class="px-6 py-4 border-2 border-gray-200 rounded-2xl focus:ring-4 focus:ring-green-500/20 focus:border-green-500 transition-all duration-300 text-lg bg-white hover:border-green-400">
