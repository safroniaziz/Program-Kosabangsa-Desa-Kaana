        ...
        <div class="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-8 text-white" data-aos="fade-up" data-aos-delay="600">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
                <div class="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                    <div class="flex items-center justify-between mb-3">
                        <div class="text-sm text-blue-200 font-medium">Kualitas SDM</div>
                        <svg class="w-5 h-5 text-blue-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path>
                        </svg>
                    </div>
                    <div class="text-4xl font-bold mb-2" data-counter="{{ $indices['human_resource_quality'] }}">0</div>
                    <div class="text-xs text-blue-200 mb-3">Rata-rata: Kesejahteraan + Pendidikan + Usia Produktif</div>
                    <div class="h-2 bg-white/20 rounded-full overflow-hidden">
                        <div class="h-full {{ $statusColors[$indices['status_color']] ?? 'bg-amber-500' }}" style="width: {{ $indices['human_resource_quality'] }}%"></div>
                    </div>
                ...
                <div class="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                    ...
                    <div class="text-xs text-blue-200 mb-3">Warga yang pernah mengenyam pendidikan formal</div>
                    <div class="h-2 bg-white/20 rounded-full overflow-hidden">
