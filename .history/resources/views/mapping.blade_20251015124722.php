...
<section class="py-16 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div class="chart-container">
                <div class="flex items-center justify-between mb-6">
                    <h3 class="text-lg font-semibold text-gray-900">Peta Desa Kaana</h3>
                    <button class="text-sm text-blue-600 hover:text-blue-700">Lihat Detail</button>
                </div>
                <div class="h-64 bg-gradient-to-br from-green-50 to-blue-50 rounded-lg relative overflow-hidden">
                    <!-- Map Background -->
                    ...
                    <div class="absolute bottom-12 right-16">
                        <div class="w-4 h-4 bg-yellow-500 rounded-full border-2 border-white shadow-lg"></div>
                        <div class="absolute -top-8 left-1/2 transform -translate-x-1/2 bg-gray-800 text-white text-xs px-2 py-1 rounded whitespace-nowrap">
                            Bukit
                        </div>
                    </div>
                    ...
                    <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                        <div class="w-4 h-4 bg-purple-500 rounded-full border-2 border-white shadow-lg"></div>
                        <div class="absolute -top-8 left-1/2 transform -translate-x-1/2 bg-gray-800 text-white text-xs px-2 py-1 rounded whitespace-nowrap">
                            Pusat Desa
                        </div>
                    </div>
