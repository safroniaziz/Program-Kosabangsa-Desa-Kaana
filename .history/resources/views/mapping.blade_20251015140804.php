        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="glass rounded-2xl p-6">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <div class="flex space-x-2">
                            <button id="satellite-btn" class="px-3 py-1 text-xs bg-blue-100 text-blue-700 rounded-full hover:bg-blue-200 transition-colors">Satelit</button>
                            <button id="street-btn" class="px-3 py-1 text-xs bg-gray-100 text-gray-700 rounded-full hover:bg-gray-200 transition-colors">Jalan</button>
                        </div>
                    </div>
            ...
            <div class="space-y-6" data-aos="fade-left">
                ...
                <div class="glass rounded-2xl p-6">
                    ...
                    <div class="space-y-3">
                        <div class="flex justify-between">
                            ...
                            <span class="font-medium">-5.35°, 102.26°</span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-gray-600">Ketinggian:</span>
                            <span class="font-medium">15-25 mdpl</span>
                        </div>
                        <div class="flex justify-between">
                        ...
                        <div class="flex justify-between">
                            ...
                            <span class="font-medium">Enggano</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="glass rounded-2xl p-6">
                    ...
                    <div class="space-y-3">
                        <div class="flex justify-between">
                            <span class="text-gray-600">Suhu Rata-rata:</span>
                            <span class="font-medium">26-28°C</span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-gray-600">Curah Hujan:</span>
                            <span class="font-medium">2.500mm/tahun</span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-gray-600">Kelembaban:</span>
                            <span class="font-medium">80-85%</span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-gray-600">Musim Kering:</span>
                            <span class="font-medium">Jun-Sep</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="glass rounded-2xl p-6">
                    ...
                    <div class="space-y-3">
                        <div class="p-3 bg-blue-50 rounded-lg">
                            <div class="font-medium text-blue-900">Kapal Laut</div>
                            <div class="text-sm text-blue-700">2x seminggu dari Bengkulu</div>
                        </div>
                        <div class="p-3 bg-green-50 rounded-lg">
                            <div class="font-medium text-green-900">Speedboat</div>
                            <div class="text-sm text-green-700">3-4 jam perjalanan</div>
                        </div>
                        <div class="p-3 bg-yellow-50 rounded-lg">
                            <div class="font-medium text-yellow-900">Pesawat Kecil</div>
                            <div class="text-sm text-yellow-700">Insidental (cuaca baik)</div>
                        </div>
                    </div>
                </div>
            </div>
