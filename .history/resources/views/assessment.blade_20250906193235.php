                        ...
                        <div class="space-y-4">
                            <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-4 border border-blue-200">
                                <div class="flex items-center justify-between mb-2">
                                    <span class="text-sm font-medium text-blue-800">Keseluruhan</span>
                                    <span id="overall-progress" class="text-sm font-bold text-blue-600">0%</span>
                                </div>
                            ...
                            <div class="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-4 border border-green-200">
                                <div class="flex items-center justify-between mb-2">
                                    <span class="text-sm font-medium text-green-800">Bagian Saat Ini</span>
                                    <span id="section-progress" class="text-sm font-bold text-green-600">0%</span>
                                </div>
