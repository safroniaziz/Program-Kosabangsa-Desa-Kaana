...
<section class="py-20 bg-white">
    <div class="container mx-auto px-4">
        <div class="max-w-4xl mx-auto text-center mb-16" data-aos="fade-up" data-aos-duration="800">
            ...
            <h2 class="text-4xl font-bold text-slate-900 mb-6" data-aos="fade-up" data-aos-delay="200">
                Path Pembelajaran Terstruktur
            </h2>
            <p class="text-xl text-slate-600 leading-relaxed" data-aos="fade-up" data-aos-delay="300">
