...
/* If there's a back to top button, adjust its position */
.back-to-top {
    bottom: 110px !important; /* Move back to top button much higher */
    right: 24px !important; /* Align with chat button */
...
@media (max-width: 768px) {
    #floatingChatBtn {
        right: 20px;
        bottom: 80px; /* Higher on mobile to avoid conflicts */
    }

    .back-to-top {
        bottom: 150px !important; /* Even higher on mobile */
        right: 20px !important; /* Align with chat button on mobile */
    }
}

@media (min-width: 769px) {
    .back-to-top {
        bottom: 120px !important; /* Higher on desktop */
        right: 24px !important; /* Same as chat button */
    }
}

/* Generic floating button adjustments with proper alignment */
[class*="back-to-top"],
[class*="scroll-top"],
[id*="backToTop"],
[id*="scrollTop"] {
    bottom: 110px !important;
    right: 24px !important; /* Ensure same right position as chat */
    z-index: 998 !important;
    position: fixed !important;
}

/* Create our own back to top if it doesn't exist */
#backToTopBtn {
    position: fixed;
    bottom: 110px;
    right: 24px;
...
<button id="backToTopBtn" onclick="scrollToTop()" title="Kembali ke Atas">
...
$(document).ready(function() {
    ...
    function jumpToQuestion(sectionIndex, questionIndex) {
        ...
        // Keep scroll to top only for jump navigation as user expects to see the new question
        $('html, body').animate({scrollTop: $('#question-container').offset().top - 100}, 300);
    }
                ...
                <div class="flex flex-wrap gap-3 justify-center">
                    <button onclick="window.print()" class="flex items-center px-6 py-3 bg-white border-2 border-gray-300 text-gray-700 rounded-xl font-semibold hover:bg-gray-50 hover:border-gray-400 transition-all duration-300">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10z"/>
                        </svg>
                        Cetak Hasil
                    </button>
    ...
    // Fix existing back to top buttons if they exist
    $(document).on('click', '[class*="back-to-top"], [class*="scroll-top"], [id*="backToTop"], [id*="scrollTop"]', function(e) {
        e.preventDefault();
        scrollToTop();
    });
