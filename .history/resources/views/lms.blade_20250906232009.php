...
@section('title', 'Program Inkubator Bisnis Ekonomi Maritim')
...
button, .material-item, [onclick], .interactive-card {
...
.absolute.z-10, .absolute[onclick] {
    pointer-events: all;
}
...
/* Fix for gradient overlays in buttons */
button .absolute {
...
/* Ensure module cards are clickable */
                ...
                <div class="space-y-8">
                    ...
                    <div data-aos="fade-up" data-aos-delay="100">
                        <div class="inline-flex items-center gap-3 bg-white/10 backdrop-blur-sm px-6 py-3 rounded-full text-white border border-white/20">
                            ...
                            <span class="text-sm font-semibold">Program Terlengkap • Ekonomi Maritim</span>
                        </div>
                    </div>
                    ...
                    <div data-aos="fade-up" data-aos-delay="200">
                        <h1 class="text-5xl lg:text-6xl font-black text-white mb-6 leading-tight">
                            Kuasai <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-400">
                                Bisnis Maritim
                            </span>
                            <span class="block">dari Laut hingga Pasar</span>
                        </h1>
                    </div>

                    <div data-aos="fade-up" data-aos-delay="300">
                        <p class="text-xl text-gray-200 mb-8 leading-relaxed">
                            Pelajari <span class="text-blue-400 font-semibold">ekonomi maritim</span> dari
                            <span class="text-indigo-400 font-semibold">budidaya hingga bisnis</span> yang menguntungkan.
                        </p>
                    </div>
                    ...
                    <div data-aos="fade-up" data-aos-delay="400">
                        <div class="grid grid-cols-3 gap-8 mb-8">
                            ...
                            <div class="text-center">
                                ...
                                <div class="text-sm text-gray-300">Video & Materi</div>
                            </div>
                            <div class="text-center">
                                <div class="text-3xl font-bold text-purple-400 mb-2">25</div>
                                <div class="text-sm text-gray-300">Kuis Interaktif</div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="glass border border-white/20 rounded-3xl overflow-hidden backdrop-blur-xl shadow-2xl animate-float">
                            ...
                            <div class="bg-gradient-to-r from-indigo-600/80 to-purple-600/80 p-6 border-b border-white/10" data-aos="fade-down" data-aos-delay="650">
                                <div class="flex items-center justify-between">
                                    <div>
                                        <h3 class="font-bold text-white text-lg">Ekonomi Maritim & Perikanan</h3>
                                        <p class="text-indigo-100 mt-1">Dari Budidaya hingga Bisnis</p>
                                    </div>
                            ...
                            <div class="p-6 bg-white/5" data-aos="fade-up" data-aos-delay="700">
                                ...
                                <div class="space-y-3 mt-6">
                                    <div class="interactive-card flex items-center gap-3 p-3 glass rounded-lg border border-white/10" data-aos="slide-right" data-aos-delay="800">
                                        ...
                                        <div class="flex-1">
                                            <div class="text-sm font-medium text-white">Dasar-dasar Ekonomi Maritim</div>
                                            <div class="text-xs text-gray-300">8 materi • 15 jam</div>
                                        </div>
                                    ...
                                    <div class="interactive-card flex items-center gap-3 p-3 glass rounded-lg border border-white/10 opacity-70" data-aos="slide-right" data-aos-delay="900">
                                        ...
                                        <div class="flex-1">
                                            <div class="text-sm font-medium text-white">Budidaya & Akuakultur</div>
                                            <div class="text-xs text-gray-300">12 materi • 20 jam</div>
                                        </div>
                                    ...
                                    <div class="interactive-card flex items-center gap-3 p-3 glass rounded-lg border border-white/10 opacity-50" data-aos="slide-right" data-aos-delay="1000">
                                        ...
                                        <div class="flex-1">
                                            <div class="text-sm font-medium text-white">Pengolahan Hasil Laut</div>
                                            <div class="text-xs text-gray-300">10 materi • 18 jam</div>
                                        </div>
...
<section class="py-20 bg-white relative overflow-hidden">
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 max-w-7xl">
        <div class="mx-auto text-center mb-16">
            <div data-aos="fade-up">
                ...
                <h2 data-aos="fade-right" data-aos-delay="100" class="text-4xl lg:text-5xl font-black text-slate-900 mb-6">
                    Apa yang Akan Anda
                    <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">Kuasai?</span>
                </h2>
                <p data-aos="fade-left" data-aos-delay="200" class="text-xl text-slate-600 leading-relaxed">
                    Program komprehensif yang dirancang untuk membawa Anda memahami
                    <span class="font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-pink-600">ekonomi maritim dan perikanan</span> dari budidaya hingga bisnis
                </p>
            </div>
        </div>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            ...
            $outcomes = [
                [
                    'icon' => '<svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 9l3 3-3 3m5 0h3M5 20h14a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v14a2 2 0 002 2z"/></svg>',
                    'title' => 'Budidaya Ikan & Akuakultur',
                    'description' => 'Teknik budidaya ikan air tawar dan laut, manajemen kolam, dan teknologi akuakultur modern'
                ],
                [
                    'icon' => '<svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z"/></svg>',
                    'title' => 'Pengolahan Hasil Laut',
                    'description' => 'Teknologi pengolahan ikan, pembuatan produk olahan, dan standar keamanan pangan'
                ],
                [
                    'icon' => '<svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 6l3 1m0 0l-3 9a5.002 5.002 0 006.001 0M6 7l3 9M6 7l6-2m6 2l3-1m-3 1l-3 9a5.002 5.002 0 006.001 0M18 7l3 9m-3-9l-6-2m0-2v2m0 16V5m0 16l-3-3m3 3l3-3"/></svg>',
                    'title' => 'Pemasaran Produk Maritim',
                    'description' => 'Strategi pemasaran digital, branding produk laut, dan penetrasi pasar lokal-global'
                ],
                [
                    'icon' => '<svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>',
                    'title' => 'Manajemen Keuangan Maritim',
                    'description' => 'Analisis kelayakan usaha perikanan, pengelolaan cash flow, dan akses permodalan'
                ],
                [
                    'icon' => '<svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/></svg>',
                    'title' => 'Sustainable Fisheries',
                    'description' => 'Praktik perikanan berkelanjutan, konservasi laut, dan eco-friendly business model'
                ],
                [
                    ...
                    'title' => 'Teknologi Maritim Modern',
                    'description' => 'IoT untuk monitoring kolam, cold chain management, dan aplikasi digital marketing'
                ]
            ];
            @endphp
            ...
            <div class="bg-gradient-to-br from-blue-50 to-purple-50 border border-blue-200/50 rounded-2xl p-8 relative overflow-hidden">
                ...
                <div class="relative z-10">
                    <div class="text-2xl font-bold text-slate-900 mb-4" data-aos="fade-up" data-aos-delay="900">
                        ...
                        <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">Entrepreneur Maritim Sukses?</span>
                    </div>
                    <p class="text-slate-600 mb-6" data-aos="fade-up" data-aos-delay="1000">
                        Dengan kurikulum terstruktur dan mentor berpengalaman, Anda akan dikembangkan menjadi pelaku bisnis maritim handal dalam waktu singkat.
                    </p>
        ...
        <div class="mx-auto text-center mb-20">
            <div data-aos="fade-up">
                ...
                <p class="text-xl lg:text-2xl text-slate-600 leading-relaxed font-medium" data-aos="fade-up" data-aos-delay="400">
                    <span class="text-gradient font-bold">12 modul</span> terstruktur dengan
                    <span class="text-gradient-2 font-bold">50+ materi</span> pembelajaran yang akan membawa Anda
                    menjadi <span class="text-gradient-3 font-bold">entrepreneur maritim</span> handal
                </p>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto mb-20" data-aos="flip-up" data-aos-delay="600">
            <div class="glass border border-white/20 rounded-2xl p-8 text-center shadow-xl">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <span class="text-lg font-black text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-blue-600">0 dari 12 modul</span>
                </div>
                ...
                <div class="flex items-center justify-center gap-8 text-sm">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-slate-600">Terkunci: <strong class="text-slate-900">11</strong></span>
                    </div>
                </div>
                <div class="mt-6">
                    <p class="text-slate-600 italic">
                        🐟 Mulai perjalanan belajar Anda menuju menjadi Entrepreneur Maritim & Perikanan profesional!
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto">
            ...
            $modules = [
                [
                    ...
                    'icon' => '<svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 9l3 3-3 3m5 0h3M5 20h14a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v14a2 2 0 002 2z"/></svg>',
                    'materials_preview' => ['Pengenalan Ekonomi Maritim', 'Potensi Hasil Laut', 'Ekosistem Perikanan', 'Analisis Pasar Maritim'],
                    'materials_list' => [
                        [
                            'type' => 'text',
                            'title' => 'Pengenalan Ekonomi Maritim',
                            'duration' => '45 min',
                            'content' => 'Ekonomi maritim merupakan sektor yang memanfaatkan sumber daya laut untuk kegiatan ekonomi yang berkelanjutan...',
                            'optional_video' => 'https://www.youtube.com/embed/qz0aGYrrlhU',
                            'optional_file' => 'maritime-economy-guide.pdf'
                        ],
                        [
                            'type' => 'text',
                            'title' => 'Potensi Hasil Laut Indonesia',
                            'duration' => '60 min',
                            'content' => 'Indonesia memiliki potensi hasil laut yang sangat besar dengan berbagai jenis ikan dan biota laut...',
                            'optional_video' => 'https://www.youtube.com/embed/qz0aGYrrlhU'
                        ],
                        [
                            'type' => 'text',
                            ...
                            'duration' => '75 min',
                            'content' => 'Memahami rantai nilai dalam bisnis perikanan dari hulu hingga hilir...',
                            'optional_video' => 'https://www.youtube.com/embed/qz0aGYrrlhU',
                            'optional_file' => 'fisheries-ecosystem.pdf'
                        ],
                        [
                            'type' => 'text',
                            'title' => 'Analisis Pasar Produk Maritim',
                            'duration' => '90 min',
                            'content' => 'Teknik analisis pasar untuk produk hasil laut, trend konsumen, dan peluang ekspor...',
                            'optional_video' => 'https://www.youtube.com/embed/qz0aGYrrlhU'
                        ],
                        [
                            'type' => 'text',
                            'title' => 'Regulasi & Kebijakan Maritim',
                            'duration' => '60 min',
                            'content' => 'Memahami regulasi pemerintah terkait bisnis maritim dan perikanan...',
                            'optional_video' => 'https://www.youtube.com/embed/qz0aGYrrlhU'
                        ],
                        [
                            'type' => 'text',
                            'title' => 'Sustainable Marine Business',
                            'duration' => '85 min',
                            'content' => 'Prinsip-prinsip bisnis maritim berkelanjutan untuk menjaga ekosistem laut...',
                            'optional_video' => 'https://www.youtube.com/embed/qz0aGYrrlhU',
                            'optional_file' => 'sustainable-guidelines.pdf'
                        ],
                        [
                            'type' => 'text',
                            'title' => 'Teknologi dalam Perikanan',
                            'duration' => '70 min',
                            'content' => 'Pemanfaatan teknologi modern dalam bisnis perikanan dan akuakultur...',
                            'optional_video' => 'https://www.youtube.com/embed/qz0aGYrrlhU'
                        ],
                        [
                            'type' => 'text',
                            'title' => 'Studi Kasus Bisnis Maritim',
                            'duration' => '120 min',
                            'content' => 'Analisis success story dan lessons learned dari pelaku bisnis maritim sukses...',
                            'optional_file' => 'maritime-case-studies.zip'
                        ]
                    ]
                ],
                [
                    ...
                    'materials_preview' => ['Teknik Budidaya Ikan', 'Manajemen Kolam', 'Pakan & Nutrisi', 'Kontrol Kualitas Air'],
                    'materials_list' => []
                ],
                [
                    'number' => 3,
                    ...
                    'icon' => '<svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z"/></svg>',
                    'materials_preview' => ['Teknologi Pengolahan', 'Value-Added Products', 'Food Safety Standards', 'Packaging & Branding'],
                    'materials_list' => []
                ],
                [
                    'number' => 4,
                    ...
                    'icon' => '<svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 6l3 1m0 0l-3 9a5.002 5.002 0 006.001 0M6 7l3 9M6 7l6-2m6 2l3-1m-3 1l-3 9a5.002 5.002 0 006.001 0M18 7l3 9m-3-9l-6-2m0-2v2m0 16V5m0 16l-3-3m3 3l3-3"/></svg>',
                    'materials_preview' => ['Digital Marketing Strategy', 'E-commerce untuk Produk Laut', 'Social Media Marketing', 'Export Market Penetration'],
                    'materials_list' => []
                ],
                [
                    'number' => 5,
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white rounded-2xl border border-slate-200 overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 group module-card"
                    ...
                    <div class="p-4 bg-white">
                        ...
                        <div class="space-y-3">
                            @if($module['status'] === 'available')
                            <button onclick="openLearningPage({{ $module['number'] }})" class="w-full flex items-center justify-center gap-2 p-3.5 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 rounded-2xl text-white border border-green-400/50">
                                <svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M8 5v14l11-7z"/>
                                </svg>
                                <span class="font-semibold text-sm">{{ $module['progress'] > 0 ? 'Lanjutkan Belajar' : 'Mulai Belajar' }}</span>
                            </button>
                            @else
                            <div class="w-full flex items-center justify-center gap-2 p-3.5 bg-gradient-to-r from-gray-100 to-gray-200 rounded-2xl text-gray-500 border border-gray-300/50">
                                <svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 0h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/>
                                </svg>
                                <span class="font-semibold text-sm">Selesaikan modul sebelumnya</span>
                            </div>
                            @endif                            <!-- Progress bar -->
        ...
        <div class="text-center mt-20" data-aos="fade-up" data-aos-delay="600">
            <div class="glass border border-white/20 rounded-2xl p-8 max-w-2xl mx-auto hover:shadow-2xl transition-all duration-300 group">
                ...
                <p class="text-slate-600 mb-6" data-aos="fade-up" data-aos-delay="800">
                    Bergabunglah dengan ribuan entrepreneur maritim yang telah memulai bisnis mereka dengan program ini.
                </p>
                <button class="relative group bg-gradient-to-r from-emerald-500 via-blue-500 to-purple-600 hover:from-emerald-600 hover:via-blue-600 hover:to-purple-700 text-white px-10 py-4 rounded-2xl font-bold text-lg shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:scale-110 overflow-hidden" data-aos="zoom-in" data-aos-delay="900">
                    <!-- Animated background -->
                    <div class="absolute inset-0 bg-gradient-to-r from-emerald-400 via-blue-400 to-purple-500 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>

                    <!-- Shimmer effect -->
                    <div class="absolute inset-0 bg-gradient-to-r from-transparent via-white/30 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000"></div>

                    <!-- Glow effect -->
                    <div class="absolute inset-0 bg-gradient-to-r from-emerald-400/50 via-blue-400/50 to-purple-500/50 opacity-0 group-hover:opacity-100 blur-xl transition-opacity duration-500"></div>

                    <span class="relative z-10 flex items-center justify-center gap-3">
                        <svg class="w-6 h-6 group-hover:rotate-12 group-hover:scale-125 transition-all duration-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"/>
                        </svg>
                        <span class="tracking-wider">Mulai Sekarang - Gratis!</span>
                    ...
                    <div class="absolute top-2 right-2 w-2 h-2 bg-white/40 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-100"></div>
                    <div class="absolute bottom-2 left-2 w-1 h-1 bg-white/50 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-200"></div>
                    <div class="absolute top-1/2 left-2 w-1.5 h-1.5 bg-white/30 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-300"></div>
                </button>
            </div>
        </div>
    </div>
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 max-w-7xl">
        <div class="mx-auto text-center mb-20" data-aos="fade-up" data-aos-duration="600">
            ...
            <p class="text-xl lg:text-2xl text-slate-600 leading-relaxed max-w-7xl mx-auto" data-aos="fade-up" data-aos-delay="200">
                ...
                <span class="block mt-2 text-lg text-blue-600 font-semibold">dari pemula hingga expert ekonomi maritim</span>
            </p>
        </div>
            ...
            <div class="relative roadmap-timeline">
                ...
                $learningPath = [
                    [
                        ...
                        'title' => 'Dasar-dasar Ekonomi Maritim',
                        'duration' => '4-6 minggu',
                        'modules' => ['Ekonomi Maritim Fundamentals', 'Potensi Hasil Laut', 'Regulasi & Kebijakan'],
                        'description' => 'Membangun pemahaman yang kuat tentang ekonomi maritim, potensi hasil laut, dan ekosistem bisnis perikanan.',
                        'position' => 'left',
                    ...
                    [
                        'phase' => 'Production',
                        'title' => 'Budidaya & Produksi',
                        'duration' => '6-8 minggu',
                        'modules' => ['Teknik Budidaya Ikan', 'Akuakultur Modern', 'Manajemen Kolam'],
                        'description' => 'Kuasai teknik budidaya ikan, akuakultur berkelanjutan, dan teknologi produksi yang modern dan efisien.',
                        'position' => 'right',
                    ...
                    [
                        ...
                        'title' => 'Pengolahan Hasil Laut',
                        'duration' => '5-7 minggu',
                        'modules' => ['Teknologi Pengolahan', 'Value-Added Products', 'Food Safety Standards'],
                        'description' => 'Pelajari teknologi pengolahan hasil laut modern untuk menciptakan produk bernilai tambah tinggi.',
                        'position' => 'left',
                    ...
                    [
                        ...
                        'duration' => '4-6 minggu',
                        'modules' => ['Digital Marketing', 'Export Strategy', 'Business Management'],
                        'description' => 'Integrasikan seluruh aspek bisnis maritim dari produksi hingga pemasaran yang sustainable dan profitable.',
                        'position' => 'right',
        ...
        <div class="text-center mt-20" data-aos="fade-up" data-aos-delay="600">
            <div class="glass border border-white/20 rounded-2xl p-8 max-w-2xl mx-auto hover:shadow-2xl transition-all duration-300 group">
                ...
                <button class="relative group bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 hover:from-purple-600 hover:via-pink-600 hover:to-red-600 text-white px-10 py-4 rounded-2xl font-bold text-lg shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:scale-110 overflow-hidden" data-aos="zoom-in" data-aos-delay="900">
                    <!-- Animated background -->
                    <div class="absolute inset-0 bg-gradient-to-r from-purple-400 via-pink-400 to-red-400 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>

                    <!-- Shimmer effect -->
                    <div class="absolute inset-0 bg-gradient-to-r from-transparent via-white/30 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000"></div>

                    <!-- Glow effect -->
                    <div class="absolute inset-0 bg-gradient-to-r from-purple-400/50 via-pink-400/50 to-red-400/50 opacity-0 group-hover:opacity-100 blur-xl transition-opacity duration-500"></div>
        ...
        <div class="modal-content bg-white/95 backdrop-blur-sm rounded-3xl max-w-6xl w-full max-h-[90vh] overflow-hidden shadow-2xl border border-white/20 transform scale-95 transition-all duration-500">
            ...
            <div class="relative gradient-bg-1 text-white p-8 overflow-hidden">
                ...
                <div class="relative z-10 flex items-center justify-between">
                    <div>
                        <h2 id="modalTitle" class="text-3xl font-black mb-2">Dasar-dasar Ekonomi Maritim</h2>
                        <div class="flex items-center gap-6 text-white/90">
                            <div class="flex items-center gap-2">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                </svg>
                                <span class="font-medium">15 jam pembelajaran</span>
                            </div>
                            <div class="flex items-center gap-2">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
...
function scrollToModules() {
    console.log('scrollToModules called'); // Debug log
    const modulesSection = document.getElementById('modules');
    if (modulesSection) {
        modulesSection.scrollIntoView({
            behavior: 'smooth'
        });
        console.log('Scrolling to modules section'); // Debug log
    } else {
        console.error('Modules section not found'); // Debug log
    }
}
...
function openModule(moduleNumber, moduleData) {
    console.log('openModule called with:', moduleNumber, moduleData); // Debug log
    currentModule = moduleData;
    if (!currentModule) {
        console.error('No module data provided'); // Debug log
        return;
    }
    ...
    if (modalTitle) {
        modalTitle.textContent = currentModule.title;
    }
    ...
    if (!modal) {
        console.error('Learning modal not found'); // Debug log
        return;
    }
...
function getMaterialDescription(title) {
    const descriptions = {
        'Pengenalan Ekonomi Maritim': 'Dalam materi ini, Anda akan mempelajari dasar-dasar ekonomi maritim, potensi hasil laut, dan peluang bisnis di sektor perikanan.',
        'Potensi Hasil Laut Indonesia': 'Pelajari berbagai jenis ikan dan biota laut Indonesia yang memiliki nilai ekonomi tinggi dan peluang bisnis.',
        'Ekosistem Bisnis Perikanan': 'Kuasai rantai nilai dalam bisnis perikanan dari hulu hingga hilir untuk memaksimalkan profit.',
        'Analisis Pasar Produk Maritim': 'Pelajari teknik analisis pasar untuk produk hasil laut, trend konsumen, dan peluang ekspor.',
        'Regulasi & Kebijakan Maritim': 'Memahami regulasi pemerintah terkait bisnis maritim dan perikanan untuk kepatuhan usaha.',
        'Sustainable Marine Business': 'Teknik untuk membangun bisnis maritim berkelanjutan yang menjaga ekosistem laut.',
        'Teknologi dalam Perikanan': 'Buat inovasi teknologi dalam bisnis perikanan untuk meningkatkan produktivitas dan kualitas.',
        'Studi Kasus Bisnis Maritim': 'Aplikasikan semua pengetahuan yang telah dipelajari untuk menganalisis success story bisnis maritim.'
    };
    return descriptions[title] || 'Pelajari konsep penting dalam pengembangan bisnis maritim modern.';
}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    window.openLearningPage = function(moduleNumber) {
        window.location.href = `/learning/${moduleNumber}`;
    };    // Initialize AOS
