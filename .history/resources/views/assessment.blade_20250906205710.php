...
<div id="chatConseling" class="fixed top-0 right-0 h-full w-96 bg-white shadow-2xl transform translate-x-full transition-transform duration-300 ease-in-out z-50 border-l border-gray-200 flex flex-col">
    ...
    <!-- Chat Messages Area -->
    <div id="chatMessages" class="flex-1 overflow-y-auto p-3 bg-gray-50" style="height: 400px;">
        <!-- Welcome Message -->
        <div class="mb-3">
    ...
    <div class="p-2 bg-gray-100 border-t" style="max-height: 140px;">
    ...
    <div class="p-3 bg-white border-t border-gray-200">
        <div class="flex items-center space-x-2">
            ...
            <button onclick="sendMessage()" class="p-2.5 bg-gradient-to-r from-orange-500 to-red-500 text-white rounded-lg hover:from-orange-600 hover:to-red-600 transition-all">&acut;
