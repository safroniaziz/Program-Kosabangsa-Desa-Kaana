...
.custom-popup .mapboxgl-popup-content {
    border-radius: 1rem;
    padding: 0;
    box-shadow: 0 25px 60px rgba(15, 23, 42, 0.25), 0 0 0 1px rgba(148, 163, 184, 0.1);
    overflow: hidden;
    background: #ffffff;
    max-width: 320px;
            ...
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div class="metric-grid" data-aos="fade-left" data-aos-delay="150">
                    <div class="metric-card">
                        ...
                        <div class="metric-value" data-counter="1250">0</div>
                        <p class="metric-label">Jumlah Penduduk</p>
                        <p class="metric-subtext">Analitik demografi terverifikasi 2023</p>
                    </div>
                    <div class="metric-card">
                        <div class="metric-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-sky-200" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M3 7.5l9-4.5 9 4.5v9l-9 4.5-9-4.5v-9z" />
                            </svg>
                        </div>
                        <div class="metric-value" data-counter="329">0</div>
                        <p class="metric-label">Kepala Keluarga</p>
                        <p class="metric-subtext">Aktif terdaftar pada administrasi desa</p>
                    </div>
                    <div class="metric-card">
                        <div class="metric-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-sky-200" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 10.5l7.5 7.5 7.5-7.5m-15 0l3-3 4.5 4.5 4.5-4.5 3 3" />
                            </svg>
                        </div>
                        <div class="metric-value" data-counter="25">0</div>
                        <p class="metric-label">UMKM Aktif</p>
                        <p class="metric-subtext">Cluster usaha prioritas desa</p>
                    </div>
                    <div class="metric-card">
                        <div class="metric-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-sky-200" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 4.5h15v15h-15v-15zm3 3v9m4.5-9v9m4.5-9v9" />
                            </svg>
                        </div>
                        <div class="metric-value" data-counter="15">0</div>
                        <p class="metric-label">Dusun &amp; Rukun Warga</p>
                        <p class="metric-subtext">Wilayah kerja pemerintahan desa</p>
                    </div>
                </div>
            </div>
        </div>
...
<section id="analytics" class="py-20 bg-white">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        <div class="text-center mb-16" data-aos="fade-up">
            ...
            <p class="section-subtitle mt-4">
                Ringkasan indikator utama kependudukan, ekonomi, dan kesiapan SDM sebagai dasar perencanaan pembangunan.
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16" data-aos="fade-up" data-aos-delay="120">
            <div class="data-card text-center space-y-4">
                ...
                <div class="text-4xl font-semibold text-slate-900" data-counter="1250">0</div>
                <p class="text-sm font-medium uppercase tracking-wide text-slate-500">Total Penduduk</p>
                <p class="text-sm text-slate-500">Kepadatan 201 jiwa/km²</p>
            </div>

            <div class="data-card text-center space-y-4">
                <div class="inline-flex items-center justify-center w-14 h-14 rounded-full bg-emerald-100 text-emerald-600 mx-auto">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 7V3m0 4a4 4 0 014 4v3m-4-7a4 4 0 00-4 4v3m12-1v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0h.01M4 12h.01" />
                    </svg>
                </div>
                <div class="text-4xl font-semibold text-slate-900" data-counter="329">0</div>
                <p class="text-sm font-medium uppercase tracking-wide text-slate-500">Kepala Keluarga</p>
                <p class="text-sm text-slate-500">Rata-rata 3,8 anggota per KK</p>
            </div>

            <div class="data-card text-center space-y-4">
                <div class="inline-flex items-center justify-center w-14 h-14 rounded-full bg-violet-100 text-violet-600 mx-auto">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M3 7h18M5 7v10a2 2 0 002 2h10a2 2 0 002-2V7M5 7l2-3h10l2 3" />
                        <path stroke-linecap="round" stroke-linejoin="round" d="M9 12h6m-6 4h3" />
                    </svg>
                </div>
                <div class="text-4xl font-semibold text-slate-900" data-counter="25">0</div>
                <p class="text-sm font-medium uppercase tracking-wide text-slate-500">UMKM Aktif</p>
                <p class="text-sm text-slate-500">Klaster perdagangan &amp; kelautan</p>
            </div>

            <div class="data-card text-center space-y-4">
                <div class="inline-flex items-center justify-center w-14 h-14 rounded-full bg-amber-100 text-amber-600 mx-auto">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M3 12l2-2m0 0l7-7 7 7-7 7-7-7zm2 2l7 7 7-7" />
                    </svg>
                </div>
                <div class="text-4xl font-semibold text-slate-900" data-counter="15">0</div>
                <p class="text-sm font-medium uppercase tracking-wide text-slate-500">Wilayah Dusun</p>
                <p class="text-sm text-slate-500">Sebaran layanan pemerintahan</p>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8" data-aos="fade-up" data-aos-delay="240">
            <div class="data-card space-y-4">
                <div class="flex items-center gap-4">
                    <span class="inline-flex items-center justify-center w-12 h-12 rounded-full bg-sky-100 text-sky-500">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                    ...
                    <div>
                        <h3 class="text-lg font-semibold text-slate-900">Demografi Seimbang</h3>
                        <p class="text-sm text-sky-500 font-medium">52.2% : 47.8%</p>
                    </div>
                </div>
                <p class="text-sm leading-relaxed text-slate-600">
                    Struktur gender yang relatif seimbang memberikan basis partisipasi yang kuat untuk program pemberdayaan masyarakat.
                </p>
            </div>

            <div class="data-card space-y-4">
                <div class="flex items-center gap-4">
                    <span class="inline-flex items-center justify-center w-12 h-12 rounded-full bg-emerald-100 text-emerald-500">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M13 10V3L4 14h7v7l9-11h-7z" />
                        </svg>
                    </span>
                    <div>
                        <h3 class="text-lg font-semibold text-slate-900">Dominasi Usia Produktif</h3>
                        <p class="text-sm text-emerald-500 font-medium">54.4% penduduk aktif</p>
                    </div>
                </div>
                <p class="text-sm leading-relaxed text-slate-600">
                    Mayoritas penduduk berada pada rentang usia produktif sehingga potensial untuk peningkatan produktivitas ekonomi lokal.
                </p>
            </div>

            <div class="data-card space-y-4">
                <div class="flex items-center gap-4">
                    <span class="inline-flex items-center justify-center w-12 h-12 rounded-full bg-violet-100 text-violet-500">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M12 14l9-5-9-5-9 5 9 5zm0 0l9-5v6.75l-9 5-9-5V9l9 5z" />
                        </svg>
                    </span>
                    <div>
                        <h3 class="text-lg font-semibold text-slate-900">Kualitas Pendidikan</h3>
                        <p class="text-sm text-violet-500 font-medium">4.2% lulusan perguruan tinggi</p>
                    </div>
                </div>
                <p class="text-sm leading-relaxed text-slate-600">
                    Investasi pendidikan menghasilkan SDM kompetitif yang siap mengakselerasi inovasi dan adopsi teknologi desa.
                </p>
            </div>
        </div>
    </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div class="chart-container" data-aos="fade-right">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <span class="data-chip">Update 2023</span>
                </div>

                <div class="flex items-center justify-center mb-10">
                    <div class="relative w-52 h-52">
                        <div class="absolute inset-0 rounded-full" style="background: conic-gradient(#2563eb 0% 52%, #ec4899 52% 100%);"></div>
                        <div class="absolute inset-5 bg-white rounded-full flex items-center justify-center">
                            <div class="text-center">
                                <div class="text-3xl font-semibold text-slate-900" data-counter="1250">0</div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="data-card">
                        <div class="flex items-center justify-between mb-3">
                            ...
                            <span class="text-xs font-medium text-slate-500">52.2%</span>
                        </div>
                        <div class="text-2xl font-semibold text-sky-600" data-counter="652">0</div>
                    ...
                    <div class="data-card">
                        <div class="flex items-center justify-between mb-3">
                            ...
                            <span class="text-xs font-medium text-slate-500">47.8%</span>
                        </div>
                        <div class="text-2xl font-semibold text-rose-500" data-counter="598">0</div>
            ...
            <div class="chart-container" data-aos="fade-left">
                ...
                <div class="space-y-4">
                    <div class="flex items-center gap-4">
                        <div class="w-24 text-sm font-medium text-slate-600">Balita</div>
                        <div class="flex-1 h-3 rounded-full bg-slate-100">
                            <div class="h-full rounded-full bg-sky-500" style="width: 20%;"></div>
                        </div>
                        <div class="w-16 text-sm font-semibold text-slate-600 text-right">83</div>
                    </div>
                    <div class="flex items-center gap-4">
                        <div class="w-24 text-sm font-medium text-slate-600">Anak-anak</div>
                        <div class="flex-1 h-3 rounded-full bg-slate-100">
                            <div class="h-full rounded-full bg-emerald-500" style="width: 28%;"></div>
                        </div>
                        <div class="w-16 text-sm font-semibold text-slate-600 text-right">175</div>
                    </div>
                    <div class="flex items-center gap-4">
                        <div class="w-24 text-sm font-medium text-slate-600">Remaja</div>
                        <div class="flex-1 h-3 rounded-full bg-slate-100">
                            <div class="h-full rounded-full bg-indigo-500" style="width: 22%;"></div>
                        </div>
                        <div class="w-16 text-sm font-semibold text-slate-600 text-right">139</div>
                    </div>
                    <div class="flex items-center gap-4">
                        <div class="w-24 text-sm font-medium text-slate-600">Dewasa</div>
                        <div class="flex-1 h-3 rounded-full bg-slate-100">
                            <div class="h-full rounded-full bg-violet-500" style="width: 18%;"></div>
                        </div>
                        <div class="w-16 text-sm font-semibold text-slate-600 text-right">112</div>
                    </div>
                    <div class="flex items-center gap-4">
                        <div class="w-24 text-sm font-medium text-slate-600">Lansia</div>
                        <div class="flex-1 h-3 rounded-full bg-slate-100">
                            <div class="h-full rounded-full bg-amber-500" style="width: 12%;"></div>
                        </div>
                        <div class="w-16 text-sm font-semibold text-slate-600 text-right">74</div>
                    </div>
                </div>
                ...
                <div class="mt-8 p-4 rounded-xl bg-slate-50 border border-slate-100">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-lg font-semibold text-slate-900">54.4% penduduk</p>
                        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
            <div class="chart-container" data-aos="fade-right" data-aos-delay="120">
                ...
                <div class="space-y-3">
                    <div class="flex items-center justify-between p-3 rounded-lg border border-emerald-100 bg-emerald-50/70">
                        ...
                        <span class="text-sm font-semibold text-slate-700">1.062 (85%)</span>
                    </div>
                    <div class="flex items-center justify-between p-3 rounded-lg border border-amber-100 bg-amber-50/70">
                        ...
                        <span class="text-sm font-semibold text-slate-700">125 (10%)</span>
                    </div>
                    <div class="flex items-center justify-between p-3 rounded-lg border border-rose-100 bg-rose-50/70">
                        ...
                        <span class="text-sm font-semibold text-slate-700">38 (3%)</span>
                    </div>
                    <div class="flex items-center justify-between p-3 rounded-lg border border-violet-100 bg-violet-50/70">
                        ...
                        <span class="text-sm font-semibold text-slate-700">25 (2%)</span>
                    </div>
                </div>
            </div>
            ...
            <div class="chart-container" data-aos="fade-left" data-aos-delay="120">
                ...
                <div class="space-y-4 mb-8">
                    <div class="flex items-center gap-4">
                        <div class="w-28 text-sm font-medium text-slate-600">Mampu</div>
                        <div class="flex-1 h-3 rounded-full bg-slate-100">
                            <div class="h-full rounded-full bg-emerald-500" style="width: 35%;"></div>
                        </div>
                        <div class="w-20 text-sm font-semibold text-slate-600 text-right">437 KK</div>
                    </div>
                    <div class="flex items-center gap-4">
                        <div class="w-28 text-sm font-medium text-slate-600">Menengah</div>
                        <div class="flex-1 h-3 rounded-full bg-slate-100">
                            <div class="h-full rounded-full bg-sky-500" style="width: 50%;"></div>
                        </div>
                        <div class="w-20 text-sm font-semibold text-slate-600 text-right">625 KK</div>
                    </div>
                    <div class="flex items-center gap-4">
                        <div class="w-28 text-sm font-medium text-slate-600">Kurang mampu</div>
                        <div class="flex-1 h-3 rounded-full bg-slate-100">
                            <div class="h-full rounded-full bg-amber-500" style="width: 12%;"></div>
                        </div>
                        <div class="w-20 text-sm font-semibold text-slate-600 text-right">150 KK</div>
                    </div>
                    <div class="flex items-center gap-4">
                        <div class="w-28 text-sm font-medium text-slate-600">Rentan miskin</div>
                        <div class="flex-1 h-3 rounded-full bg-slate-100">
                            <div class="h-full rounded-full bg-rose-500" style="width: 3%;"></div>
                        </div>
                        <div class="w-20 text-sm font-semibold text-slate-600 text-right">38 KK</div>
                    </div>
                </div>
                <div class="p-4 rounded-xl bg-amber-50 border border-amber-100">
                    <p class="text-sm text-amber-700 font-medium">
                        74 KK tercakup program bantuan sosial aktif pemerintah kabupaten.
                    </p>
                </div>
            </div>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const desaPointsOfInterest = [
        {
            name: 'Danau Onta',
            description: 'Danau alami yang menjadi ikon wisata desa.',
            coordinates: [102.26697600871147, -5.476712441788056],
            category: 'nature'
        },
        {
            name: 'Danau Pulau',
            description: 'Danau pesisir dengan ekosistem penting.',
            coordinates: [102.33866884546806, -5.403715473561784],
            category: 'nature'
        },
        {
            name: "Masjid Pal Empat Ka'ana",
            description: 'Masjid utama yang melayani warga di Pal Empat.',
            coordinates: [102.35621881872818, -5.4038399900619],
            category: 'worship'
        },
        {
            name: 'Pesantren As Salam Al Azhar',
            description: 'Lembaga pendidikan Islam tingkat pesantren.',
            coordinates: [102.34737400107242, -5.385645633181521],
            category: 'education'
        },
        {
            name: 'Al Muhsineen Jami Mosque Kaana',
            description: 'Masjid jami pusat aktivitas keagamaan masyarakat.',
            coordinates: [102.34750067015548, -5.375209707505798],
            category: 'worship'
        },
        {
            name: 'Pantai Kikuba',
            description: 'Pantai pasir putih dengan panorama sunset.',
            coordinates: [102.35125850293794, -5.3721312219924755],
            category: 'nature'
        },
        {
            name: "Pantai Ka'ana Enggano",
            description: 'Pesona pantai utama Desa Kaana.',
            coordinates: [102.34494120137057, -5.371939736733691],
            category: 'nature'
        },
        {
            name: 'Kaana Beach Camp & Resort',
            description: 'Akomodasi wisata dan area rekreasi pantai.',
            coordinates: [102.34261861727693, -5.371497895633549],
            category: 'tourism'
        },
        {
            name: 'Pondok Kebun',
            description: 'Kebun dan pondok warga untuk agrowisata.',
            coordinates: [102.33559135559713, -5.374811972028578],
            category: 'tourism'
        },
        {
            name: "Pantai Be'wa Trans Malakoni",
            description: 'Spot wisata pantai dengan akses mudah dari Trans Kaana.',
            coordinates: [102.3306204926123, -5.364648747359315],
            category: 'nature'
        },
        {
            name: "Masjid Trans Ka'ana",
            description: 'Masjid yang melayani komunitas Trans Kaana.',
            coordinates: [102.32477676957377, -5.367506250804365],
            category: 'worship'
        }
    ];

    const categoryStyles = {
        nature: { gradient: 'from-teal-500 to-emerald-500', emoji: '🌿' },
        worship: { gradient: 'from-indigo-500 to-sky-500', emoji: '🕌' },
        education: { gradient: 'from-amber-500 to-orange-500', emoji: '📚' },
        tourism: { gradient: 'from-rose-500 to-fuchsia-500', emoji: '🏖️' },
        default: { gradient: 'from-slate-500 to-slate-600', emoji: '📍' }
    };
    ...
    desaPointsOfInterest.forEach(point => {
        ...
        new mapboxgl.Marker({ element: markerEl, anchor: 'center' })
            ...
            .setPopup(new mapboxgl.Popup({
                ...
                <div class="p-3">
                    <h4 class="font-semibold text-base text-slate-900 mb-1">${point.name}</h4>
