...
<div id="chatConseling" class="fixed top-0 right-0 h-full w-96 bg-white shadow-2xl transform translate-x-full transition-transform duration-300 ease-in-out z-50 border-l border-gray-200">
    ...
    <!-- Chat Messages Area -->
    <div id="chatMessages" class="flex-1 overflow-y-auto p-4 bg-gray-50" style="height: calc(100vh - 400px);">
        <!-- Welcome Message -->
        <div class="mb-4">
            <div class="flex items-start">
                <div class="w-8 h-8 bg-orange-500 rounded-full flex items-center justify-center mr-3 flex-shrink-0">
    ...
    <div class="p-3 bg-gray-100 border-t">
        <p class="text-xs text-gray-600 mb-2">Respon Cepat:</p>
        <div class="space-y-1">
            <button onclick="sendQuickMessage('Saya merasa cemas dan butuh bantuan')" class="w-full text-left p-2 bg-white rounded-lg text-xs hover:bg-blue-50 transition-colors border border-gray-200">
                😰 Saya merasa cemas dan butuh bantuan
            </button>
            <button onclick="sendQuickMessage('Bagaimana cara mengelola stress?')" class="w-full text-left p-2 bg-white rounded-lg text-xs hover:bg-blue-50 transition-colors border border-gray-200">
                🧘 Bagaimana cara mengelola stress?
            </button>
            <button onclick="sendQuickMessage('Saya ingin konsultasi lebih lanjut')" class="w-full text-left p-2 bg-white rounded-lg text-xs hover:bg-blue-50 transition-colors border border-gray-200">
                💬 Saya ingin konsultasi lebih lanjut
            </button>
        </div>
    </div>
