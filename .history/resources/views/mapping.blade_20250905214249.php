...
@section('title', 'Pemetaan Potensi Desa - Infografik Statistik')

@section('content')
<!-- Hero Section with Advanced Dashboard Design -->
<section class="relative py-32 overflow-hidden">
    <!-- Animated Background with Data Visualization Theme -->
    <div class="absolute inset-0 bg-gradient-to-br from-indigo-900 via-purple-900 to-indigo-900">
        <!-- Floating Data Elements -->
        <div class="absolute top-20 left-16 w-36 h-36 bg-purple-500/20 rounded-lg floating-element blur-xl transform rotate-12"></div>
        <div class="absolute bottom-24 right-20 w-28 h-28 bg-indigo-500/20 rounded-lg floating-element blur-xl transform -rotate-12"></div>
        <div class="absolute top-1/2 left-1/2 w-96 h-96 bg-violet-500/10 rounded-full blur-3xl transform -translate-x-1/2 -translate-y-1/2"></div>
    ...
    <div class="relative z-10 max-w-6xl mx-auto text-center px-4 sm:px-6 lg:px-8">
        ...
        <h1 class="text-5xl md:text-7xl font-bold text-white mb-8 animate-fade-in-up">
            Pemetaan <span class="text-gradient">Potensi Desa</span>
        </h1>

        <p class="text-xl md:text-2xl text-gray-200 mb-12 animate-fade-in-up max-w-5xl mx-auto leading-relaxed">
            Dashboard interaktif dengan visualisasi data real-time, analytics mendalam, dan infografik potensi desa untuk mendukung pengambilan keputusan strategis berbasis data.
        </p>

        <!-- Enhanced Key Metrics -->
        <div class="grid grid-cols-3 gap-8 max-w-4xl mx-auto mb-12 animate-fade-in-up">
            <div class="text-center glass-card p-8 rounded-3xl backdrop-blur-lg shadow-2xl group card-hover">
                <div class="bg-gradient-to-br from-purple-500 to-indigo-600 w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-xl group-hover:scale-110 transition-transform duration-300">
                    <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path>
                    </svg>
                </div>
                <div class="text-4xl font-bold text-white mb-2 group-hover:text-purple-300 transition-colors">15</div>
                <div class="text-purple-200 font-medium">Dusun Aktif</div>
            </div>

            <div class="text-center glass-card p-8 rounded-3xl backdrop-blur-lg shadow-2xl group card-hover">
                <div class="bg-gradient-to-br from-indigo-500 to-blue-600 w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-xl group-hover:scale-110 transition-transform duration-300">
                    <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path>
                    </svg>
                </div>
                <div class="text-4xl font-bold text-white mb-2 group-hover:text-indigo-300 transition-colors">1,250</div>
                <div class="text-purple-200 font-medium">Total Penduduk</div>
            </div>

            <div class="text-center glass-card p-8 rounded-3xl backdrop-blur-lg shadow-2xl group card-hover">
                <div class="bg-gradient-to-br from-violet-500 to-purple-600 w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-xl group-hover:scale-110 transition-transform duration-300">
                    <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                    </svg>
                </div>
                <div class="text-4xl font-bold text-white mb-2 group-hover:text-violet-300 transition-colors">25</div>
                <div class="text-purple-200 font-medium">UMKM Berkembang</div>
            </div>
        </div>

        <div class="flex flex-col sm:flex-row gap-6 justify-center animate-fade-in-up">
            <a href="#dashboard" class="btn-primary text-white px-10 py-5 rounded-2xl font-semibold text-lg inline-flex items-center justify-center morph-btn glow-border relative overflow-hidden group">
...
<section id="dashboard" class="py-32 bg-gradient-to-br from-gray-50 to-purple-50 relative overflow-hidden">
    <!-- Background Elements -->
    <div class="absolute top-0 right-0 w-96 h-96 bg-purple-200/30 rounded-full translate-x-1/2 -translate-y-1/2 blur-3xl"></div>
    <div class="absolute bottom-0 left-0 w-80 h-80 bg-indigo-200/30 rounded-full -translate-x-1/2 translate-y-1/2 blur-3xl"></div>

    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-20 animate-fade-in-up">
            <span class="inline-block px-6 py-3 bg-purple-100 text-purple-800 rounded-full text-sm font-semibold mb-6">
                📈 Analytics Dashboard
            </span>
            <h2 class="text-5xl md:text-6xl font-bold text-gray-900 mb-8 text-gradient">
                Statistik Utama
            </h2>
            <p class="text-xl md:text-2xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
                Ringkasan data real-time mengenai demografi, ekonomi, dan potensi pengembangan Desa Kaana dengan visualisasi interaktif yang mudah dipahami.
            </p>
        </div>
    ...
    const chartObserver = new IntersectionObserver((entries) => {
        entries.forEach(entry => {
            if (entry.isIntersecting) {
                entry.target.querySelectorAll('.animate-grow-bar').forEach((bar, index) => {
                    setTimeout(() => {
