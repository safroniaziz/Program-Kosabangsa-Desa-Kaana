...
<div id="resultsModal" class="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 items-center justify-center p-4" style="display: none;">
    <div class="bg-white rounded-2xl max-w-md w-full max-h-[85vh] overflow-hidden shadow-2xl transform scale-95 opacity-0 transition-all duration-300" id="modalContent">
        ...
        const resultsHTML = `
            <div class="result-card">
                ...
                <div class="text-center mb-4">
                    ...
                    <h2 class="text-xl font-bold text-gray-900 mb-1">Hasil Assessment</h2>
