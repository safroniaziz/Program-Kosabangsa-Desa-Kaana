        ...
        const resultsHTML = `
            <div class="result-card">
                ...
                <div class="text-center mb-4">
                    <h2 class="text-2xl font-bold text-gray-900 mb-2">Hasil Assessment</h2>
                    <p class="text-sm text-gray-600">Evaluasi Kesiapan Mental Menghadapi Bencana</p>
                </div>

                <!-- Status Indicator -->
                <div class="text-center mb-4">
                    <div class="status-indicator ${statusClass} mb-3">
                ...
                <div class="grid grid-cols-3 gap-3 mb-4">
                    <div class="text-center p-3 bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg border border-blue-200">
                        <div class="text-xl font-bold text-blue-600 mb-1">${Math.round((score/3) * 100)}%</div>
                        <div class="text-xs font-medium text-blue-800">Skor</div>
                    </div>
                    <div class="text-center p-3 bg-gradient-to-br from-green-50 to-green-100 rounded-lg border border-green-200">
                        <div class="text-xl font-bold text-green-600 mb-1">${Object.keys(answers).length}</div>
                        <div class="text-xs font-medium text-green-800">Jawaban</div>
                    </div>
                    <div class="text-center p-3 bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg border border-purple-200">
                        <div class="text-xl font-bold text-purple-600 mb-1">${assessmentData.sections.length}</div>
                        <div class="text-xs font-medium text-purple-800">Bagian</div>
                    </div>
                </div>
                ...
                ${needsCounseling ? `
                    <div class="recommendation-card">
                        ...
                        <h3 class="text-lg font-bold text-orange-900 mb-2 text-center">💬 Konsultasi Virtual</h3>
                        <p class="text-orange-800 text-center text-sm mb-3">
                            Berdasarkan hasil assessment, disarankan berkonsultasi dengan konselor profesional.
                        </p>
                        <div class="grid grid-cols-3 gap-2 text-xs">
                            <div class="flex items-center justify-center p-2 bg-white bg-opacity-50 rounded">
                                <span class="font-medium">Gratis</span>
                            </div>
                            <div class="flex items-center justify-center p-2 bg-white bg-opacity-50 rounded">
                                <span class="font-medium">Rahasia</span>
                            </div>
                            <div class="flex items-center justify-center p-2 bg-white bg-opacity-50 rounded">
                ...
                ` : `
                    <div class="recommendation-card-success">
                        ...
                        <h3 class="text-lg font-bold text-green-900 mb-2 text-center">🎉 Luar Biasa!</h3>
                        <p class="text-green-800 text-center text-sm">
                            Kesiapan mental Anda sudah sangat baik. Tetap pertahankan dengan berlatih rutin.
                        </p>
                    </div>
                `}
