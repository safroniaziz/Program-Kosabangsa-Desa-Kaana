                ...
                <div class="space-y-8">
                    ...
                    <div data-aos="fade-up" data-aos-delay="300">
                        <p class="text-xl text-gray-200 mb-8 leading-relaxed">
                            ...
                            <span class="text-purple-400 font-semibold">pemetaan fasilitas kesehatan</span> untuk mendukung kesejahteraan masyarakat Desa Kaana.
            </p>
        </div>
                    ...
                    <div data-aos="fade-up" data-aos-delay="400">
                        <div class="grid grid-cols-3 gap-8 mb-8">
                            ...
                            <div class="text-center glass border border-white/20 rounded-2xl p-4 hover:scale-105 transition-transform">
                                <div class="text-3xl font-bold text-blue-400 mb-2" data-counter="{{ $totalFaskes ?? 0 }}">0</div>
                                <div class="text-sm text-gray-300">Fasilitas Kesehatan</div>
                            </div>
                            <div class="text-center glass border border-white/20 rounded-2xl p-4 hover:scale-105 transition-transform">
                                <div class="text-3xl font-bold text-purple-400 mb-2" data-counter="{{ $totalAssessmentsCompleted ?? 0 }}">0</div>
                                <div class="text-sm text-gray-300">Assessment Selesai</div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="glass border border-white/20 rounded-3xl overflow-hidden backdrop-blur-xl shadow-2xl animate-float">
                            ...
                            <div class="p-6 bg-white/5">
                                ...
                                <div class="grid grid-cols-2 gap-4 mb-6">
                                    ...
                                    <div class="glass rounded-xl p-4 border border-white/10">
                                        <div class="text-xs text-gray-300 mb-2">Completion Rate</div>
                                        <div class="relative w-full h-12">
                                            <svg viewBox="0 0 36 36" class="w-full h-full">
                                                ...
                                                <path d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831"
                                                      ...
                                                      stroke-dasharray="{{ $assessmentCompletionRate ?? 0 }}, 100"/>
                                                <defs>
                                            ...
                                            <div class="absolute inset-0 flex items-center justify-center">
                                                <span class="text-lg font-bold text-white">{{ $assessmentCompletionRate ?? 0 }}%</span>
                                            </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="space-y-3">
                                    <div class="flex items-center gap-3 p-3 glass rounded-lg border border-white/10">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <div class="text-xs text-gray-300">{{ number_format($transactionsToday ?? 0) }} transactions today</div>
                                        </div>
                                        <div class="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
                </div>
                                    ...
                                    <div class="flex items-center gap-3 p-3 glass rounded-lg border border-white/10">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <div class="text-xs text-gray-300">{{ number_format($activeAssessments ?? 0) }} active assessments</div>
                                        </div>
                                        <div class="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
                </div>
