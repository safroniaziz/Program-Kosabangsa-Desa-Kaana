...
<div id="chatConseling" class="fixed top-0 right-0 h-full w-96 bg-white shadow-2xl transform translate-x-full transition-transform duration-300 ease-in-out z-50 border-l border-gray-200">
    ...
    <div class="p-2 bg-gray-100 border-t" style="max-height: 180px; overflow-y: auto;">
        <p class="text-xs text-gray-600 mb-2 font-medium">Respon Cepat:</p>
        ...
        <div class="mt-2 text-center">
            <button onclick="updateQuickResponses()" class="text-xs text-blue-600 hover:text-blue-800 transition-colors">
                🔄 Refresh Pertanyaan
            </button>
        </div>
    </div>
...
$(document).ready(function() {
    ...
    function updateQuickResponses() {
        ...
        const selectedResponses = shuffleArray(allResponses).slice(0, 6);
