...
<section class="relative min-h-screen overflow-hidden">
    ...
    <div class="absolute inset-0 overflow-hidden">
        <div class="floating-element absolute top-20 right-20 w-24 h-24 bg-gradient-to-br from-blue-400/30 to-purple-600/30 rounded-full blur-2xl animate-float"></div>
        <div class="floating-element absolute bottom-32 left-1/4 w-32 h-32 bg-gradient-to-br from-indigo-400/20 to-blue-600/20 rounded-full blur-2xl animate-float" style="animation-delay: -3s;"></div>
    </div>
    ...
    <div class="container mx-auto px-4 relative z-10">
        <div class="max-w-4xl mx-auto text-center mb-16">
            <div class="animate-fadeInUp">
                ...
                <h2 class="text-4xl lg:text-5xl font-black text-slate-900 mb-6 animate-slideInLeft">
                    Apa yang Akan Anda 
                    <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">Pelajari?</span>
                </h2>
                <p class="text-xl text-slate-600 leading-relaxed animate-slideInRight" style="animation-delay: 0.2s;">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div class="group animate-scaleIn" style="animation-delay: {{ ($index * 0.1) + 0.3 }}s;">
        ...
        <div class="max-w-3xl mx-auto text-center mt-16 animate-fadeInUp" style="animation-delay: 1.8s;">
            <div class="bg-gradient-to-br from-blue-50 to-purple-50 border border-blue-200/50 rounded-2xl p-8 relative overflow-hidden">
                ...
                <div class="relative z-10">
                    ...
                    <div class="inline-flex items-center gap-2 text-sm font-semibold text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-blue-600">
    ...
    <div class="container mx-auto px-4 relative z-10">
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="bg-white rounded-2xl border border-slate-200 overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 group">
