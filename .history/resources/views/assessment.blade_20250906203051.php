...
<div id="chatConseling" class="fixed top-0 right-0 h-full w-96 bg-white shadow-2xl transform translate-x-full transition-transform duration-300 ease-in-out z-50 border-l border-gray-200">
    ...
    <div class="p-2 bg-gray-100 border-t">
        ...
        <div class="space-y-1">
            <button onclick="sendQuickMessage('Saya merasa cemas dan butuh bantuan')" class="w-full text-left p-1.5 bg-white rounded text-xs hover:bg-blue-50 transition-colors border border-gray-200">
                😰 Saya merasa cemas
            </button>
            <button onclick="sendQuickMessage('Bagaimana cara mengelola stress?')" class="w-full text-left p-1.5 bg-white rounded text-xs hover:bg-blue-50 transition-colors border border-gray-200">
                🧘 Cara mengelola stress?
            </button>
            <button onclick="sendQuickMessage('Saya ingin konsultasi lebih lanjut')" class="w-full text-left p-1.5 bg-white rounded text-xs hover:bg-blue-50 transition-colors border border-gray-200">
