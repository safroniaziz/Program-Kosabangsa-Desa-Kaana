            ...
            <div class="xl:col-span-3" data-aos="fade-right">
                <div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
                    ...
                    <div class="relative">
                        ...
                        <div class="absolute bottom-4 left-4 bg-white/95 backdrop-blur-sm rounded-lg px-3 py-2 text-xs text-gray-700 shadow-md border border-gray-200">
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
                    ...
                    <div class="p-4 space-y-3">
                        ...
                        <div class="flex items-center justify-between py-2 border-t border-gray-50">
                            ...
                            <span class="font-semibold text-blue-600 text-sm">Enggano</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
                    ...
                    <div class="p-4 space-y-3">
                        ...
                        <div class="flex items-center justify-between py-2 border-t border-gray-50">
                            ...
                            <span class="font-semibold text-green-600 text-sm">Jun-Sep</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
                    ...
                    <div class="p-4 space-y-3">
                        <div class="flex items-center p-3 bg-blue-50 rounded-xl border border-blue-100">
                            <div class="w-10 h-10 bg-blue-600 rounded-lg flex items-center justify-center mr-3">🚢</div>
                            <div class="flex-1">
                        ...
                        <div class="flex items-center p-3 bg-green-50 rounded-xl border border-green-100">
                            <div class="w-10 h-10 bg-green-600 rounded-lg flex items-center justify-center mr-3">⚡</div>
                            <div class="flex-1">
                                <div class="font-semibold text-green-900 text-sm">Speedboat</div>
                                <div class="text-xs text-green-700">3-4 jam perjalanan</div>
                            </div>
                        </div>
                        <div class="flex items-center p-3 bg-orange-50 rounded-xl border border-orange-100">
                            <div class="w-10 h-10 bg-orange-600 rounded-lg flex items-center justify-center mr-3">✈️</div>
                            <div class="flex-1">
                                <div class="font-semibold text-orange-900 text-sm">Pesawat Kecil</div>
                                <div class="text-xs text-orange-700">Insidental (cuaca baik)</div>
                            </div>
                        </div>
                    </div>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    satelliteBtn.addEventListener('click', function() {
        ...
        satelliteBtn.classList.add('bg-blue-600', 'text-white');
        streetBtn.classList.remove('bg-blue-600', 'text-white');
    ...
    streetBtn.addEventListener('click', function() {
        ...
        streetBtn.classList.add('bg-blue-600', 'text-white');
        satelliteBtn.classList.remove('bg-blue-600', 'text-white');
