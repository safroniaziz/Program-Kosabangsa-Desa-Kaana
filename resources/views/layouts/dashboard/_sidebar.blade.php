<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="225px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_sidebar_mobile_toggle">
    ...
    <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
        ...
        <a href="{{ route('dashboard') }}" class="d-flex align-items-center">
            ...
            <img alt="Logo" src="{{ asset('images/logo.png') }}" class="h-35px app-sidebar-logo-minimize d-none" />
        ...
        <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper">
            ...
            <div id="kt_app_sidebar_menu_scroll" class="scroll-y my-3 mx-3" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar_menu" data-kt-scroll-offset="5px" data-kt-scroll-save-state="true">
                ...
                <div class="menu menu-column menu-rounded menu-sub-indention fw-semibold fs-6" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
                    ...
                    <div class="menu-item {{ Route::is('admin.questions.index') ? 'show' : '' }}">
                        <a class="menu-link {{ Route::is('admin.questions.index') ? 'active' : '' }}" href="{{ route('admin.questions.index') }}">
                            <span class="menu-icon">
                    ...
                    <!--begin:Menu item-->
                    <div class="menu-item {{ Route::is('admin.coordinates.index') ? 'show' : '' }}">
                        <!--begin:Menu link-->
                        <a class="menu-link {{ Route::is('admin.coordinates.index') ? 'active' : '' }}" href="{{ route('admin.coordinates.index') }}">
                            <span class="menu-icon">
                                <i class="fa fa-map-marker-alt fs-4"></i>
                            </span>
                            <span class="menu-title">Koordinat Lokasi</span>
                        </a>
                        <!--end:Menu link-->
                    </div>
                    ...
                    <div class="menu-item {{ Route::is('admin.reports.index') ? 'show' : '' }}">
                        <!--begin:Menu link-->
                        <a class="menu-link {{ Route::is('admin.reports.index') ? 'active' : '' }}" href="{{ route('admin.reports.index') }}">
                            <span class="menu-icon">
                                <i class="fa fa-chart-bar fs-4"></i>
                            </span>
                    ...
                    <div class="menu-item {{ Route::is('assessment.demo-history') ? 'show' : '' }}">
                        <a class="menu-link {{ Route::is('assessment.demo-history') ? 'active' : '' }}" href="{{ route('assessment.demo-history') }}">
                            <span class="menu-icon">
                                <i class="fa fa-history fs-4"></i>
                            </span>
                            <span class="menu-title">Riwayat Assessment</span>
                        </a>
                    </div>
