...
@section('link')
    ...
    <li class="breadcrumb-item">
        <a href="{{ route('admin.questions.index') }}" class="text-muted text-hover-primary">Questions</a>
    </li>
    <li class="breadcrumb-item text-gray-700">PTSD Questions</li>
@endsection
