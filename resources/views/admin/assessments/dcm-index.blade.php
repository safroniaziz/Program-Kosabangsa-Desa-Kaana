...
@section('title', 'DCM Assessments - Admin')
...
@section('link')
    ...
    <li class="breadcrumb-item text-gray-700">DCM</li>
@endsection
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">DCM Assessments (DASS-21)</h3>
            ...
            <div class="card-body">
                <div class="alert alert-info">
                    <i class="fas fa-info-circle"></i> This page shows all DCM assessments completed using the DASS-21 questionnaire.
                </div>

                <table id="dcm-assessments-table" class="table table-bordered table-striped">
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>User</th>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">DCM Assessment Details</h5>
...
<script>
    $(function () {
        let table = $('#dcm-assessments-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: {
                url: "{{ route('admin.assessments.dcm.data') }}",
                type: 'GET'
            },
            columns: [
                ...
                {data: 'depression', name: 'depression'},
