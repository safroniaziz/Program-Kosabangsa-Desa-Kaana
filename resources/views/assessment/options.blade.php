                    ...
                    <div class="flex items-start">
                        ...
                        <div class="ml-4">
                            ...
                            <div class="mt-2 flex flex-wrap gap-3">
                                <a href="{{ route('assessment.history') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors text-sm font-medium">
        ...
        <div class="grid md:grid-cols-2 gap-8 mb-12">
            ...
            <div class="group relative" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="relative bg-white/95 backdrop-blur-sm rounded-2xl shadow-xl p-8 hover:bg-white transition-all duration-300 transform hover:-translate-y-2">
                    ...
                    <!-- Action Button -->
                    @auth
                        <a href="{{ route('assessment.start-new', 1) }}" class="btn-assessment w-full inline-flex items-center justify-center px-6 py-4 bg-gradient-to-r from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 group">
