                ...
                <div class="h-full flex flex-col">
                    ...
                    <div class="mb-6">
                        <div class="flex items-center mb-4">
                            ...
                            <div>
                                <h2 class="text-2xl font-bold text-gray-900">Riwayat Assessment DCM Terbaru</h2>
                    ...
                    <div class="flex-1 overflow-y-auto">
                        ...
                        @else
                            <div class="text-center py-12">
                                ...
                                <p class="text-gray-500 text-sm">Anda belum pernah mengerjakan assessment DCM sebelumnya.</p>
                            </div>
                        @endif
                    </div>
                </div>
                ...
                <div class="h-full flex flex-col">
                    ...
                    <div class="mb-6">
                        <div class="flex items-center mb-4">
                            ...
                            <div>
                                <h2 class="text-2xl font-bold text-gray-900">Assessment DCM Baru</h2>
                                <p class="text-gray-600 text-sm">Mulai assessment dari awal dengan data bersih</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4 mb-6">
                        <div class="flex items-center justify-between p-4 bg-emerald-50 rounded-lg">
                            ...
                            <span class="font-bold text-emerald-600">69 Pertanyaan</span>
                        </div>
                        <div class="flex items-center justify-between p-4 bg-purple-50 rounded-lg">
                            <span class="text-gray-700 font-medium">Estimasi Waktu:</span>
                            <span class="font-bold text-purple-600">20-25 Menit</span>
                        </div>
